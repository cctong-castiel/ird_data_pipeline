...
2.
This  Departmental  Interpretation  &  Practice  Notes  No.  10  (“DIPN
...
Goepfert, 2 HKTC 210.
In the 1987 version of DIPN 10, the Department has
...
3.
Since  the  issue  of  the  1987  revision  of  DIPN  10,  the  Board  of
...
Goepfert  decision 1 .  There  is  indeed  a  need  to  bring  the  1987  version
up-to-date.

In this present revision, the Department does not seek to introduce a
4.
...
The question of where the employment or the source of income was
5.
...
“It  follows  that  the  place  where  the  services  are  rendered  is
...
“If  any  authority  be  needed  for  this  basic  proposition  one
...
is  no  suggestion  that  the  payment  was  nominal  or
...
“There can be no doubt therefore that in deciding the crucial
...
this  very  process.
If  that  is  what  it  means  then  it  is  not  an
...
“Having  stated  what  I  consider  to  be  the  proper  test  to  be
...
I  hasten  to  add,  however,  that  the  ‘60  days  rule’  does  not
...
“On  the  other  hand,  if  a  person,  whose  income  does  not  fall
...
‘60
chargeable to salaries tax.  Again, this is subject to the
days rule’.” (page 238)

The Department accepts the learned judge’s view and would follow
6.
...
In determining where the source of income, the
...
7.
The contract to be considered is that which is currently in force and
...
8.
The  Department  expects  to  be  provided  with  a  copy  of  the
In
employment  contract  properly  executed  by  the  employer  and  employee.
...
written  contract  be  provided.
If,  as  a  matter  of  fact,  a  written  contract  does
...
9.
While  the  Department  would  generally  accept  the  parties  named  in
...
In  testing  whether  a  true  employer-employee  relationship  exists
10.
...
11.
It would be up to the taxpayer to provide the full facts as to where
...
12.
If the employer is resident in Hong Kong, it is unlikely that a claim
...
In  a  contract  of  employment,  the  parties  are  free  to  choose  the
13.
...
From  the  above  guideline,  in  determining  where  an  employment
14.
...
him and where that business is located.
...
In  determining  the  residence  of  a  corporation,  the  Department  will
16.
...
I
is carried on.  Those decisions have been acted upon ever since.
regard that as the true rule; and the real business is carried on where
the central management and control actually abides.”

In  Charter  View  Holdings  (BVI)  Ltd.  v.  Corona  Investments  Ltd.  &
17.
Another,  [1998]  1  HKLRD  469 3,  the  issue  of  whether  the  plaintiff  was
...
(ii)  	 All  the  circumstances  in  which  the  company  carries  on  its
...
In applying the test to a non-trading company, it may be more
...
In applying the “central management and control” test in the situation
19.
of  a  subsidiary  company  and  its  parent  operating  in  another  territory,  the

9

Department  would  normally  regard  the  subsidiary  and  its  parent  as  separate
...
In  this  regard,  the  Department  is  mindful  of  the
...
20.
In  support  of  claims  that  the  employer  is  centrally  managed  and
...
Surely  source  of  employment,  which  should  be
this  case.
...
22.
The significance of the place of payment for the present purpose was
...
course  an  important  indicator  of  the  locality  of  the  contract  and  is
prima facie the locality of the contract.    But it is not conclusive: see
for  example  Bennett  v  Marshall9 .
If  an  employee  enters  into  a
...
The  Department  will  readily  follow  the  above  approach.  Payment
23.
...
In  support  of  claims  that  salaries  are
...
If a person claims that his employment with an employer resident in
24.
...
In summary, if the source of employment is located in Hong Kong,
25.
...
apportionment.  However,  if  a  non-Hong  Kong  employment  exists  then  any
...
26.
In  general,  the  Department  would  accept  that  a  non-Hong  Kong
...
General  statements  made  by  taxpayers  or  their  representatives  that
27.
...
Where  a  non-Hong  Kong  employment  exists,  consideration  will  be
28.
...
For the purposes of quantifying the amount of income derived from
29.
...
remuneration including leave pay on a time-in time-out basis.
In exceptional
...
In  order  to  arrive  at  the  amount  of  income  derived  from  services
30.
...
31.
Subsection (b) of section 8(1A) excludes from the charge to Salaries
...
[section 8(1B)].
In other words, a person who renders services in Hong Kong
...
Thus, an employee deriving income from a Hong Kong employment,
32.
...
total of 60 days in the basis period of a year of assessment.  On the other hand,
...
The  exclusion  under  section  8(1A)(b)  only  refers  to  visits,  e.g.  a
33.
...
Fees paid to persons who hold the office of director of a corporation
34.
...
of director held by the taxpayer was located in Hong Kong.
In this case, the
...
The  liability  of  ship  and  aircraft  personnel  is  determined  under
35.
...
basis periods for two consecutive years of assessment, one of which is the year
...
36.
Following  the  introduction  of  section  8(1A)(c)  with  effect  from  1
...
37.
Whether a particular foreign tax is of substantially the same nature as
...
issue.
In  order  to  qualify  under  section  8(1A)(c)  all  that  is  required  is
...
On  a  practical  point,  cases  may  arise  where  the  basis  period  for
38.
...
chargeable,  may  not  actually  have  been  assessed  and  paid.
In  this  situation,
...
There may also be a situation in which the taxpayer is not aware that
39.
...
If  the  taxpayer  has  to  pay  foreign  tax  after  the
...
It  should  be  noted  that  as  a  matter  of  practice  section  8(1A)(c)  has
40.
...
F  Asia  Pacific  Ltd  was  the  regional  headquarter  of  a  group  of  companies  in
