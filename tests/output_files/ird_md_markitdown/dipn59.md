...
Economic circumstances of the parties and of the market in which
...
Ordinance  (Cap.  112)  (the  IRO),  enacted  under
the  Inland  Revenue
...
4.
For  a  variety  of  reasons,  the  business  arrangements  and  pricing
...
replacing  (hypothetically)  the  actual  conditions  (e.g.  price)
...
6.
The  complexities  of  applying  the  arm’s  length  principle  in  practice
...
It  is  possible  that  application  of  the  OECD’s  guidelines  may  not
7.
...
Transfer  pricing  is  not  an  exact  science.    There  will  be  many
8.
...
The  general  application  of  the  arm’s  length  principle  in  a  double
9.
...
in  comparable  transactions  and  comparable  circumstances  …
...
11.
Article 9 is concerned with the conditions and profits resulting from
...
The  arm’s  length  principle  effectively  requires  an  assessment  of
12.
...
The  key  consideration  is  whether  the  transaction  or  arrangement
13.
...
14.
Where  independent  enterprises  in  comparable  circumstances  would
...
15.
This  raises  the  question  of  whether  the  transaction  or  arrangement
...
16.
In  practice,  it  may  be  appropriate  not  to  recognize  the  associated
...
length  pricing  cannot  reliably  be  determined  for
that
transaction or arrangement.

5

Both  of  these  situations  are  instances  where  the  associated  enterprises’
...
17.
Implicit in the concept of the arm’s length principle is the notion that
...
The identification of arm’s length provision depends on a survey of
18.
...
It is not of itself sufficient to infer that independent enterprises might
19.
...
20.
It may be the case that it can be hypothesized on a rational basis that
...
interests of the tested party having regard to the options realistically available
to  it,  including  the  option  of  not  entering  the  tested  relations  if  independent
enterprises would not have done so.

21.
If property or service is purchased without a reasonable expectation
...
Rule  1  is  entirely  consistent  with  the  guidance  provided  in
...
transaction  as  accurately  delineated  may  be
...
there  was  no  market  based  evidence  such  as  comparable
comparable  data
uncontrolled
...
the static pricing mechanism used in such an arrangement was
unusual  and  would  likely  be  unacceptable  to  both  an  arm’s
length transferor and an arm’s length transferee;

it  did  not  make  commercial  sense  for  Corporation-HK  to  sell
...
The  arrangement  was  commercially
irrational  since  neither
...
In accordance with the guidance laid down in the TPG, the structure
...
Rule 1 requires income or loss from transactions between associated
23.
...
a  provision  (actual  provision)  has  been  made  or  imposed  as
...
the actual provision differs from the provision that would have
been  made  or  imposed  as  between  two  independent  persons
(arm’s length provision); and

(d)

the actual provision confers a potential advantage in relation to
...
is to be computed as if the arm’s length provision had been  made or imposed
instead  of  the  actual  provision.    The  amount  of  income  or  loss  computed  is
referred to as the arm’s length amount.

25.
Section  50AAF(1)  requires  a  comparison  to  be  made  between  the
...
26.
The existence of a DTA is not a prerequisite for application of Rule 1.
...
27.
Section  50AAE  of  the  IRO  requires,  among  other  things,  that
...
the commentary on the associated enterprises article contained
in the MTC; and
...
there might be choice between two or more approaches to the
identification of the arm’s length provision; and

10

(b)  when determining the effect given to section 50AAF, it might
...
Profits arising in or derived from Hong Kong shall be fully charged
30.
...
Section 50AAF(3), as a due process, provides that the Assessor may
31.
...
32.
Section  50AAF(5)  provides  that  if  the  person  fails  to  prove  to  the
...
issue  a  computation  of  loss,  or  revise  a  computation  of  loss
resulting  in  a  smaller  amount  of  computed  loss,  in  respect  of
the person.

The combined effect of section 50AAF(3) and (5) should enable the
33.
...
Section 50AAF(6) provides that the estimated amount is taken to be
34.
...
35.
Section  50AAF  aims  to  prevent  under-assessment  of  income  or
...
36.
Rule 1 should not be used to achieve double non-taxation of profits
...
Where  there  is  any  difficulty  in  obtaining  information  about  the
37.
...
Section  50AAF  would  apply  in  determining  an  affected  person’s
38.
...
director’s  income  for  property  tax  purposes  under  section  50AAN.
...
40.
The  word  “provision”  embraces  all  the  terms  and  conditions
...
41.
Section 50AAF(2) provides that the cases in which a provision made
...
42.
The  basic  criterion  for  application  of  Rule  1  requires  there  to  be  a
...
The  word  “transaction”  is  defined  in  section  50AAI  to  include  any
43.
...
A  series  of  transactions  includes  a  number  of  transactions  each
44.
entered into (whether or not one after the other) in pursuance of, or in relation

15

to the same matter.    Transactions within a series of transactions do not have to
...
A  series  of  transactions  is  not  prevented  from  being  regarded  as  a
45.
...
there is no transaction in the series to which both those persons
are parties;

the  parties  to  any  arrangement  or  scheme  in  pursuance  of
which  the  transactions  in  the  series  are  entered  into  do  not
include one or both of those persons;

(c)

there is one or more transactions in the series to which neither
...
There was no direct transaction between Parent Corporation-F1 and
Subsidiary  Corporation-HK;  third  parties  were  involved;  and  the
involved  neither  Parent
transaction  marked  with  an  asterisk
...
Bank-F
in  Jurisdiction-F  which  made  a  loan  to  Subsidiary
...
In  relation  to  a  provision  made  or  imposed  as  between  two  persons

(a)

(b)

regardless  of  whether  either  person  is,  or  both  persons  are,
chargeable to foreign tax; and

if  either  person  is,  or  both  persons  are,  chargeable  to  foreign
...
As between affected persons, the participation condition is met under
47.
...
one  of
the
the  affected  persons  was  participating
management, control or capital of the other affected person; or

in

the  same  person  or  persons  was  or  were  participating  in  the
management  or  control  or  capital  of  each  of  the  affected
persons.

A person (person A) is participating in  the  management, control  or
48.
...
a  corporation,  partnership,  trustee  (whether  incorporated  or
...
The  participation  condition  was  met  since  Associated  Corporation-
...
Person A has the power to secure that the affairs of person B
...
person  A  has  more  than  half  of  the  direct  or  indirect
...
person A is, directly or indirectly, entitled to exercise or
...
(b)  Person  B  is  accustomed  or  under  an  obligation  (whether
...
In  determining  whether  person  A  has  a  direct  beneficial  interest  in
...
if person B is a corporation that is not a trustee of a trust estate:
the  percentage  of  the  issued  share  capital  of  the  corporation
held by person A;

if person B is a partnership that is not a trustee of a trust estate:
the  percentage  of  the  income  of  the  partnership  to  which
person A is entitled;

if person B is a trustee of a trust estate: the percentage in value
of the trust estate in which person A is interested; or

if  person  B  is  an  entity  that  does  not  fall  within  any  of  the
...
52.
If  person  A  has  an  indirect  beneficial  interest  in,  or  is  indirectly
...
in
Corporation-3;  and  Corporation-3  held  70%
Corporation-4.
...
Where  there  is  a  potential  advantage,  it  should  be  addressed  in  the
54.
...
The  charging  of  a  non-arm’s
length  fee  caused  Associated
...
if the actual provision is made or imposed in connection with
each affected person’s trade, profession or business carried on
in Hong Kong; or

(b)

if an affected person is resident for tax purposes in Hong Kong
...
each  affected  person’s  income  arising  from  the  relevant
...
no concession or exemption for Hong Kong tax applies to any
affected  person’s  income  or  loss  arising  from  the  relevant
activities.

The  no  actual  tax  difference  condition  seeks  to  ensure  that  the
58.
...
59.
If  the  actual  provision  does  not  confer  a  potential  advantage  in
...
to
Associated  Corporation-HK1  sold
...
tax  difference  was  met  since:  Associated
The  no  actual
...
Corporation-HK2
relevant  activities  of  Associated
...
for  Associated  Corporation-HK2  would  not  be  a
proceeds
consideration when determining whether the no actual tax difference

25

condition was  met.    The mere fact that one  of the affected persons
...
service
  Profits  of
from  Associated  Corporation-HK2.
...
60.
The non-business loan condition is met if the actual provision relates
...
In  determining  whether  a  company  is  carrying  on  an  intra-group
61.
financing  business,  reference  can  be  made  to  Departmental  Interpretation  and
Practice Notes No. 52.

62.
Having regard to the totality of facts, it is considered that a company
...
development business in Hong Kong.    Associated Corporation-HK2,
the parent company, was carrying on an investment holding business
  Associated  Corporation-HK1  borrowed  an
in  Hong  Kong.
interest-free  loan  from  Associated  Corporation-HK2  to  finance  its

28

long-term  equity  investment  (accepted  as  capital  in  nature)  in  a
number  of  property  development  companies
Associated Corporation-HK1 and Associated Corporation-HK2 were
...
intra-group  financing  business  of  Associated
lending  or  an
Corporation-HK2, the non-business loan condition would be met.

No tax avoidance condition

An actual provision has a tax avoidance purpose if the Commissioner
63.
...
The  expression  “main  purpose  or  one  of  the  main  purposes”  is
64.
...
65.
Whether  specified  transactions  had  been  carried  out  for  bona  fide
...
the policy of the company in the area where the transaction or transactions in
...
66.
Transfer pricing looks to charge the right amount of tax on the right
...
Under  Rule  1,  the  actual  provision  is  only  substituted  by  the  arm’s
67.
...
68.
Section 4(3) of Schedule 44 to the IRO provides, among others, that
...
Corporation-HK  to  customers  in  Hong  Kong.    Based  on  the  terms
...
Associated  Corporation-HK  was  a  corporate
treasury  center
...
of the loan were complete, and the rights of the borrower and lender
...
69.
Application of the arm’s length principle is based on comparison of
...
identify  the  commercial  or  financial  relations  between  the
...
The functional analysis assists in assessing the level of comparability
70.
...
71.
The  functional  analysis  is  not  a  transfer  pricing  methodology  but  a
...
the  availability  of  comparables  in  relation  to  prices  or
functions;

the  degree  of  comparability  in  respect  of  the  person’s
uncontrolled transactions or those undertaken by other persons
considered as possible comparables; and

the  relative  importance  of  the  functions,  assets  and  risks  of
each  of  the  associated  persons  to  the  value  added  to  the
transactions  in  cases  where  a  transactional  profit  method  is
needed.

72.
In  complex  or  composite  transactions  involving  distinctive  markets
...
73.
In Asia Master Limited v CIR 7 HKTC 25, the Court of First Instance
...
business  description  such  as  “limited
risk  distributor”  or  “contract
manufacturer”.
...
76.
To reconstruct the consideration paid or received under a controlled
...
The  comparison  of  a  controlled  transaction  with  an  uncontrolled
...
Identification  of  potential  comparables:  determining  the
to  be  met  by  any  uncontrolled
key  characteristics
transaction
to  be  regarded  as  potentially
...
The  accurate  delineation  of  the  actual  transaction  between  the
81.
associated  persons
relevant
...
82.
The contractual terms of an arm’s length transaction define explicitly
...
arrangement,  Corporation-F  acquired  existing  sales  contracts
...
terms with third party customers were for payment in full within 30
  Corporation-F  was  contractually  required  to  transfer
days.
...
83.
Where  a  transaction  has  been  formalized  by  the  associated  person
...
was  silent  about  any  marketing  and  advertising  activities  in
...
84.
If the associated persons are transacting on open markets (e.g. quoted
...
85.
The  compilation  of  lists  of  functions,  assets  and  risks  does  not  in
...
86.
While one party may provide a large number of functions relative to
...
Differences in the specific characteristics of property or services can
87.
...
88.
Arm’s  length  prices  or  margins  may  vary  across  different  markets
...
the  markets  in  which  the  independent  and  associated  persons
operate are comparable; and

differences either do not have a material effect on price or can
be appropriately adjusted if they do have a material effect.

Business strategies pursued by the parties

89.
Business  strategies  of  a  MNE  group  are  often  formulated  by  the
...
90.
In a transfer pricing context, the question is whether an independent
person in similar circumstances might have participated in these strategies and
if so what reward it would have expected.

91.
Market  penetration  strategies  implement  conditions  whereby  parties
...
If  there  are  costs  incurred  or  profits  forgone  by  a  person  resulting
92.
from a strategy or policy, the question to be answered is which person obtains

43

benefit from these decisions and the attribution of the costs of such a policy or
strategy.
...
To  prove  that  a  business  strategy  between  associated  persons  is
94.
...
Unless
the  position  can  be  supported  by  contemporaneous
documentation  of  the  market  penetration  strategy,  it  is  highly
unlikely
that  Corporation-HK  was  pursuing  a  valid  market
penetration strategy.

Global price lists

Global  price  lists  specify  the  prices  at  which  goods  or  services  are
95.
...
have  been  reviewed  using  an  appropriate  arm’s  length
methodology;
...
are  applied  only  in  comparable  circumstances  (e.g.  where  the
...
96.
Since  markets  vary  by  location,  it  is  difficult  for  a  global  list  to
...
departures  from  perfect  market  conditions,  leading  to  some
indeterminacy in economic outcomes;

unadjusted differences in the circumstances of the transactions
involved; and
...
The most important factor influencing reliability is the way material
98.
...
99.
The  application  of  multiple  methods  can  be  useful  in  resolving
...
Details  of  various  transfer  pricing  methods  are  explained  in
101.
...
If  the  traditional  transaction  methods  are  not  applicable,  the
102.
...
106.
The  Commissioner  agrees  that  MNE  groups  should  retain  the
...
107.
Difficulties  will  often  be  encountered  if  intellectual  property  rights
...
Industry data dumps1  are not acceptable, even if additional statistical
109.
...
110.
The use of statistical tools that do not increase the reliability  of the
...
111.
Controlled  data,  obtained  from  transactions  between  two  associated
...
The TPG recognize the importance of looking to the market serviced
112.
...
Appropriately  selected  overseas  data  is  accepted.    The  same  or
113.
...
114.
Commercial  databases  can  be  a  practical  and  sometimes
...
115.
The  Commissioner  does  not  have  any  preference  on  the  databases
...
116.
Multiple year data will be useful in providing information about the
...
comparable  manner,  or  whether  different  provisions  in  an  earlier  year
...
The use of multiple years of data may be appropriate and beneficial
118.
...
The  TPG  recognizes  that  slight  differences  between  companies  can
119.
...
A  transfer  pricing  report  usually  produces  a  list  of  companies
120.
proposed as comparables.    The companies strictly will have differing margins,

50

finance  costs,  volume,  markets,  attitude  to  risk-taking  and  so  on.    Therefore,
...
In  a  case  where  all  the  comparables  being  used  are  more  or  less
121.
...
Where  the  results  of  the  tested  party  fall  outside  the  range,  the
122.
...
really  be  asked  as  to  why  the  tested  party  or  suggested  comparables  have
...
124.
Taxpayers  are  encouraged  to  review  the  continued  applicability  of
...
125.
Where  no  significant  changes  are  identified,  and  comparable  data
...
To ensure compliance with Rule 1, an administrative penalty by way
127.
...
If an assessment or additional assessment is made on a person under
128.
section 50AAF(5), such person is liable to an additional tax pursuant to section

52

82A(1C) and (1D).    The maximum additional tax is the difference between the
...
129.
If an assessment made on a person for a year of assessment has taken
...
130.
Section  82A(1G)  provides  that  no  additional  tax  under  section
...
A  reasonable  effort  means  the  degree  of  effort  that  an  independent
131.
...
there  is  no  process  in  place  or  documentation  to  check  the
selection or application of transfer pricing methods;

there is some contemporaneous documentation but no analysis
...
there is evidence of limited efforts to develop and implement a
...
non-arm’s length transactions (i.e. controlled transactions) are
used as comparables; or

the  documentation  is  prepared  with  the  use  of  inappropriate
...
133.
The  Commissioner  would  not  rule  out  the  possibilities  of  imposing
...
As  a  rule,  the  identification  of  the  arm’s  length  provision  must  be
1.
...
3.
The actual provision that operates between the associated persons in
...
4.
There must be a nexus between the actual provision that operates and
...
The  form  of  the  commercial  or  financial  relations  describes  the
5.
...
6.
The  substance  of  the  commercial  or  financial  relations  between  the
...
7.
The transaction between the associated persons can be deduced from
written  contracts  and  the  conduct  of  the  associated  persons.    Formal
to  be  clarified  and
in  contracts  should  have
...
In some  cases,  the commercial and financial relations will  not have
8.
...
all the facts and circumstances, including the behaviours of the
...
the  economic  and  financial  impacts  produced  for  the  relevant
...
10.
In most cases, it is expected that the identification of the arm’s length
...
If  associated  persons  structure  and  characterize  their  cross-border
11.
...
12.
Where reliable data show that comparable uncontrolled transactions
...
On  the  other  hand,  if  the  cross-border  commercial  or  financial
13.
...
14.
Section 50AAF(1) in effect permits the form of the commercial and
...
The  effect  is  that  some  aspects  of  the  commercial  or  financial
15.
...
Whether  the  form  and  substance  of  the  commercial  or  financial
16.
...
17.
Where  the  substance  of  the  commercial  or  financial  relations  is
...
18.
Where it can be concluded that independent persons dealing wholly
...
19.
The  requirement  that  independent  persons  would  have  entered  into
...
sufficient to identify what independent persons would have done by reference
...
Even  if  the  other  commercial  or  financial  relations  differ  in
20.
...
The  relevant  question  is  whether  the  commercial  or  financial
21.
...
22.
Whether these inferences can be drawn will depend on the facts and
...
23.
Where  the  commercial  or  financial  relations  undertaken  by  the
...
25.
Whether  these  inferences  can  be  drawn  will  be  a  matter  of  fact
...
Where  the  commercial  or  financial  relations  of  the  associated
26.
...
Strictly, there are two possible types of comparison:

(a)

internal  comparable  uncontrolled  price  where  the  price  to  the
...
external comparable uncontrolled price where the price to the
...
Reliable  application  of  the  CUP  method  requires  that  there  are  no
4.
...
transactions  could  materially  affect  the  price  in  the  open
market, or
...
5.
The  CUP  method  is  a  particularly  reliable  method  where  an
...
interest  rate  charged  on  an  inter-company  borrowing  between
associated persons;

royalties  charged  on  licensed  intangible  properties  (e.g.
...
8.
If no comparable can be found, other traditional transaction methods
...
The  cost  plus  method  uses  the  costs  incurred  by  the  supplier  of
9.
...
10.
The  cost  plus  method  will  use  margins  computed  after  direct  and
...
11.
Under  the  cost  plus  method,  the  mark-up  should  be  calculated  by
...
Ideally,  the  mark-up  of  the  seller  person  should  be  determined  by
12.
...
Whilst the level of the profit margin (i.e. the mark-up) is critical,  it
13.
...
14.
It  is  important  to  consider  differences  in  the  level  and  types  of
...
if  the  expenses  reflect  a  functional  difference  (taking  into
...
if  the  expenses  reflect  additional  functions  that  are  distinct
separate
tested  by
from
...
if  differences  in  the  expenses  of  the  persons  being  compared
...
in  Jurisdiction-F.
owned
Corporation-HK1  would  be  provided  with  all
technical
...
external  comparable  enterprise.
the
...
to
in
its  wholly  owned  subsidiary  Corporation-F  resident
...
Corporation-HK1  accounted
supervisory,  general,  and
for
...
and  Corporation-HK4,
Corporation-HK2,  Corporation-HK3
...
This was a typical setup for applying a cost plus method.    All costs
...
16.
The resale price method is based on the price at which a product that
...
17.
If  a  person  performs  all  the  functions  an  independent  distributor
...
18.
The  resale  price  method  will  be  most  useful  where  the  reseller
...
The resale price margin represents the amount out of which a reseller
19.
...
The resale price margin is expected to vary according to the amount
21.
...
if the reseller performs limited services as a forwarding agent
or broker, the comparable resale profit margin can be derived
from an examination of commission or brokerage fees;

if  the  reseller  takes  property  in  the  goods,  assumes  the
...
if the reseller, in addition to the functions and risks in (b), also
...
22.
If the reseller in its activities employs certain assets (e.g. intangibles
...
size of the geographical market and the existence and relative
competitiveness of possible substitute goods;

level  of  activity  undertaken  by  the  reseller  (e.g.  substantial
resources  are  committed  to  marketing  the  property  or  a
monopolistic turnover is realized without much effort); and

risks  associated  with  having  the  only  source  of  supply  and
...
the  parties  share  the  assumption  of  economically  significant
risks, or separately assume closely related risks.

xii

Contributions will be “unique and valuable” in cases where they are
25.
...
26.
The  profit  split  method  identifies  the  relevant  profits  to  be  split  for
...
27.
While the traditional price-based methods might continue to work in
...
If the final prices of goods do not just reflect the cost of manufacture
28.
...
After the functional analysis has been carried out to identify the real
29.
...
30.
The  profit  may  be  the  aggregate  profit  from  the  transactions  or  a
...
Where the profit split method is found to be the most appropriate, the
32.
...
Alternatively,  if  the  profit  split  method  is  found  to  be  the  most
33.
...
34.
Irrespective  of  whether  a  transactional  profit  split  of  anticipated  or
...
35.
The  relevance  of  comparable  uncontrolled  transactions  or  internal
...
be  independent  of  transfer  pricing  policy  formulation  and  be
...
36.
Asset-based  or  capital-based  profit  splitting  factors  can  be  used
...
37.
Under a contribution analysis, the relevant profits, which are the total
...
In  the  first  category  are  profits  attributable  to  contributions  which
39.
...
For  each  category,  it  is  necessary  to  have  regard  to  the  relevant
40.
...
and Corporation-F were less complex; and the residual profit should
...
Initial return for the manufacturing activities
of Corporation-HK ($60 × 10%)
Initial return for the manufacturing activities
of Corporation-F ($170 × 10%)
Total profit allocated through initial returns
...
splitting  the  relevant  profits  so  that  each  associated  person
...
splitting  the  relevant  profits  based  on  the  division  of  profits
...
engaged  in  transactions  that  are  sufficiently  comparable.    If
...
splitting the relevant profits using a flexible methodology that
the  contributions  by  different  persons  over
recognizes
economic and product life cycles;

splitting  the  relevant  profits  using  a  formula.    Weightings
...
42.
In  June  2018,  OECD  published  the  Revised  Guidance  on  the
...
the  net  margins  of  the  person’s  dealings  with  independent
...
the  net  margins  earned  in  comparable  dealings  between  two
independent persons.

45.
The  focus  is  initially  on  examining  the  net  margin  relative  to  an
...
Under the TNMM,  margins are calculated  after operating expenses.
...
47.
In the determination of the net profit indicator for the application of
...
ratio of net profit (before interest and tax) to cost of goods sold
...
Berry ratios are very sensitive to classification of costs as operating
48.
expenses  or  not  and  therefore  can  pose  comparability  issues.    To  consider

xxii

whether Berry ratio is an appropriate profit indicator, it is necessary to consider
that:
...
the person does not perform, in the controlled transactions, any
other  significant  function  (e.g.  manufacturing  function)  that
should  be  remunerated  using  another  method  or  profit
indicator.

49.
The  TNMM  is  unlikely  to  be  reliable  if  each  party  to  a  transaction
...
50.
There are a number of weaknesses peculiar to the TNMM, which can
...
Intra-group service arrangements encompass a wide array of services
1.
...
3.
The TPG further requires the intra-group service entity providing the
...
activities  to  satisfy  statutory  reporting  requirements  of  the
parent company;
...
5.
If a parent company provides services for a subsidiary that duplicate
...
To  satisfy
investors  and  legal  requirements,  Parent
...
An expenditure incurred in obtaining the supply of goods or services
7.
...
8.
Where  the  benefits  conferred  by  a  service  arrangement  provide  an
...
9.
Where  the  benefits  passing  to  the  associated  person  under  an
...
the  service  fees  and  charges  are  disproportionate  or  grossly
...
the  service  fees  and  charges  guarantee  the  service  entity  a
certain  profit  outcome  without
reasonable  commercial
explanation; or

the  service  fees  and  charges  generate  profits  in  the  service
...
In  determining  whether  the  amount  of  the  charge  is  in  accordance
11.
...
12.
A direct charge is one levied by a particular affiliate for a particular
...
An  indirect  charge  is  made  where  for  some  reason,  such  as  the
13.
...
14.
For example, charges could be calculated on the basis of head count
...
Toll  manufacturing  is  an  example  of  an  activity  that  involves
15.
...
its entire output will be purchased, assuming product quality requirements are
  Under  the  circumstances,  the  production  corporation  could  be
met.
considered  as  performing  a  service  and  the  cost  plus  method  could  be
appropriate.

16.
An  intra-group  service  entity  providing  services  to  its  associated
...
It  is  a  well-accepted  principle  that  tax  computation  needs  to  be
1.
...
2.
In Hong Kong, the market value principle has all along been applied
...
Section 15BA has codified the market value principle as reflected in
3.
...
any  acquisition  or  disposal  of  trading  asset  other  than  in  the
course of trade at market value.

In  case  of  a  change  of  intention  towards  an  asset,  section  15BA
4.
...
The  situations  to  which  section  15BA  applies  may  be  distinguished
5.
...
6.
In valuation of trading stock on cessation of business, section 15C(a)
...
Section  15BA  is  intended  to  codify  the  market  value  principle
...
(i.e.  developer
acquiring  companies)  and  Corporation-HK4
company).    Corporation-HK1  purchased  old  property  units  in  Site

ii

X  through  Corporation-HK2  and  Corporation-HK3.    After  all  the
...
8.
Section  50AAF(8)  provides  that  section  50AAF(1)  to  (6)  will  not
...
2.
The  guidance  was  developed  under  Action  8  of  the  OECD/  G20
...
3.
Chapter VI of the TPG places the guidance on intangibles within the
...
The framework for analyzing risks contained in Chapter I of the TPG
4.
...
5.
The  guidance  refers  to  the  treatment  of  the  return  to  funding
...
6.
In relation to arm’s length pricing when valuation is highly uncertain
...
legal  ownership  of  intangibles  by  an  associated  person  alone
...
an  associated  person  providing  funding  and  assuming  the
...
if  the  associated  person  providing  funding  does  not  exercise
...
The guidance contained in the Guidance for Tax Administrations on
8.
the Application of the Approach to Hard-to-Value Intangibles aims at reaching

iii

a  common  understanding  and  practice  on  how  to  apply  adjustments  resulting
...
presenting the principles that should underlie the application of
the HTVI approach by tax administrations;

providing  a  number  of  examples  clarifying  the  application  of
the HTVI approach in different scenarios; and

addressing the interaction between the HTVI approach and the
...
10.
“Intangible”  means  something  which  is  not  a  physical  asset  or  a
...
11.
For  transfer  pricing  purposes,  legal  ownership  of  intangibles,  by
...
the  intangible.    The  return  ultimately  retained  by  or  attributed  to  the  legal
...
12.
Group  members  that  use  assets  in  the  DEMPE  of  an  intangible
...
identify  the  intangibles  used  or  transferred  in  the  transaction
with specificity;

identify  the  full  contractual  arrangements  for  determining  the
legal  ownership  of
rights,
intangibles,
...
identify  the  parties  performing  the  DEMPE  functions  of  the
...
confirm  the  consistency  between  the  terms  of  the  relevant
...
delineate  the  actual  controlled  transactions  relating  to  the
DEMPE functions of the intangibles; and

determine  arm’s  length  prices  for  the  transactions  consistent
with  each  party’s  contributions  of  function  performed,  assets
used and risks assumed.

Determining arm’s length prices

Members  of  MNE  group  performing  the  DEMPE  functions,  using
15.
...
Section 15F: sums derived from intellectual properties by non-Hong Kong
resident associates

17.
Section 15F seeks to give effect to the guidance in Chapter VI of the
...
18.
The provisions in section 15F, which aligns taxation of income from
...
section 15F(1) refers to the situation where a person has made
...
section 15F(2) caters for a situation where a person has made
value  contributions
to  any
in  Hong  Kong
...
section  15F(3)  treats  that  part  of  the  sum  attributable  to  the
...
section  15F(4)  provides  that  the  non-Hong  Kong  resident
associate is not to be chargeable to profits tax in respect of the
attributable sum.

vii

For  the  purpose  of  section  15F,  the  term  “intellectual  property”  is
19.
...
20.
According to the TPG, legal ownership of intangibles, by itself, does
...
21.
The  effect  of  section  15F  is  that  a  person  who  has  contributed  in
...
not  perform  any  of  the  relevant  functions  in  relation  to  the
...
Associated  Corporation-HK  sold  a  self-developed
intellectual
...
to  perform  DEMPE
if  Associated  Corporation-HK  continued
