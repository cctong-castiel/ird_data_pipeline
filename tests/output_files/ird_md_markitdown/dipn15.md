...
(I)
  ...
  LOSS COMPANIES
  RAMSAY PRINCIPLE
  PENALTY ON TAX AVOIDANCE CASES
  GUIDELINES ON LEASE FINANCING
  ADVANCE RULINGS
...
These  notes  replace  those  issued  on  1  May  1986,  on  15  November

1990 and in September 1992.
...
Application of the two general anti-avoidance
...
Information to be supplied
  ...
  Time  for  the  lodgement  of  ruling  requests  on  proposed
...
(section  61A)  and  changes  in  shareholding.
In  addition,  these  notes  set  out
...
Section 22B generally applies in respect of a share of a loss incurred
2.
...
Three  categories  of  persons  are  within  the  definition  of  a  limited
3.
...
A  limited  partner  cannot  claim  a  loss  set-off  in  excess  of  the
4.
...
The loss set-off of a limited partner is restricted to the lesser of:

(a)

his share of the partnership loss; or
...
6.
Any loss not set off is carried forward in the partnership and set off
...
7.
In applying the provisions it is necessary to ascertain the amount of
...
8.
Section 39E was enacted to limit the opportunities for tax deferral or
avoidance  through  sale  and  leaseback,  offshore  equipment  leasing  and
leveraged leasing arrangements.
In broad terms section 39E operates to deny
...
the machinery or plant was previously owned and used by the
lessee or his associate (i.e. a sale and leaseback arrangement),
or

(b)

the machinery or plant, other than a ship or aircraft or any part
thereof, is while the lease is in force:

(i)

used  wholly  or  principally  outside  Hong  Kong  by  a
person other than the lessor; or

(ii)

the  whole  or  a  predominant  part  of  its  cost  of
...
the machinery or plant is a ship or aircraft or any part thereof
and:

(i)

the  lessee  is  not  an  operator  of  a  Hong  Kong  ship  or
aircraft; or
...
Under section 2 of the Ordinance, lease in relation to any machinery
...
any  arrangement  under  which  a  right  to  use  it  is  granted  by
the owner to another person; and

any  arrangement  under  which  a  right  to  use  it,  being  a  right
derived  directly  or  indirectly  from  a  right  referred  to  in
paragraph (a), is granted by a person to another person,

3

but does not include a hire-purchase agreement or a conditional sale agreement
...
10.
In  general  the  reference  to  “taxpayer”  in  section  39E  connotes  the
...
the lessee, either alone or with others, or

(b)

an “associate” of the lessee.
...
Denial of depreciation allowances in section 39E(1)(a) is intended to
11.
prevent an overall tax benefit being obtained through the sale and leaseback of
machinery or plant.

12.
Section  39E(1)(a)  refers  to  leased  machinery  or  plant  which  at  any
...
Section  39E(2)  provides  an  exception  to  the  general  rule  that  no
13.
...
a  lessor  purchases  machinery  or  plant  from  an  end-user  at  a
...
The  conditions  in  section  39E(2)  are  satisfied.    Company  L would
...
a description of the relevant asset;
...
the date of purchase from and price paid to the supplier;

(d)

the date of sale to and price paid by the lessor; and
...
After submitting notice of a disclaimer, the end-user might decide to
15.
...
The  “used  wholly  or  principally  outside  Hong  Kong”  condition  in
16.
...
The question whether a particular item of machinery or plant is used
17.
...
the place where the asset is physically located and put to use
or held for use;
...
the nature of the end-user’s business;

(d)

the locality in which the asset is, under the terms of the lease,
...
18.
No  doubt  cases  will  arise  where  leased  machinery  or  plant  will  be
used,  either  in  one  year,  or,  over  a  period  of  years,  both  within  and  outside
In these cases the Department will look at each leased asset and
Hong Kong.
each  year  of  assessment  separately.
If  in  a  particular  year  the  machinery  or
...
would  be  given.
Strictly,  Company  D  should  be  denied
...
owner of the machinery and plant.
In effect, Company G has sold
...
20.
Where  the  asset  is  a  leased  ship  or  aircraft  the  law  prescribes  a
different test for deciding whether initial or annual allowances shall be granted
to the taxpayer (lessor) – see section 39E(1)(c).
In such cases the question is
...
in  the  case  of  an  aircraft,  holds  an  air  operator’s  certificate
issued  under  the  Air  Navigation  (Hong  Kong)  Order  1995
(Cap. 448 sub. leg. C); or

in  the  case  of  a  ship,  is  responsible  for  meeting  all,  or  a
...
A  leveraged  lease  arrangement,  as  it  has  become  known  to  this
21.
...
years  to  a  lessee  and  where,  by  reason  of  the  “leverage”  obtained  from  the
...
22.
So far as it relates to leveraged leases, section 39E denies initial and
...
23.
The term “non-recourse debt” is defined extensively in section 39E(5)
...
24.
Section  61  empowers  the  Assessor  to  disregard  certain  transactions
...
It does not itself create a liability
independent charging provision.
...
The essential factors for section 61 to apply are:
...
the  transaction  has  the  effect  of  reducing  the  tax  payable  by
the taxpayer concerned; and

the transaction is artificial or fictitious, or that any disposition
is not in fact given effect to.

The “transaction”

26.
The scope of section 61 was considered in the Hong Kong tax cases
...
fictitious  as  no  real  service  was  rendered.
In  the  Kum  Hing  case,  the  Court
...
27.
The  words  “artificial”  and  “fictitious”  though  not  defined  in  the
...
“artificial”  is  an  adjective  in  general  use  in  the  English
...
(b)
	 ...
	 a  “fictitious”  transaction  is  one  which  those  who  are
ostensibly  the  parties  to  it  never  intended  should  be  carried
out.

28.
In Cheung Wah Keung v. CIR, 5 HKTC 698, Woo JA at the Court of
...
29.
When  the  transaction  is  disregarded  pursuant  to  section  61,  the
...
The  general  anti-avoidance  provision,  section  61A,  was  introduced
30.
...
inhibitions  on  normal
arrangements  but  should  not  cast  unnecessary
...
31.
In brief, the general anti-avoidance provision, section 61A, applies to
...
entered into or carried out or in such other manner as is considered necessary to
counteract the tax benefit which would otherwise be obtained.

32.
Section  61A  is  modelled  on  the  Australian  general  anti-avoidance
...
In  order  that  section  61A  may  apply  to  a  taxpayer  there  are  three
...
there must be a transaction as defined;

(b)

the taxpayer must obtain a tax benefit as defined; and

(c)

having  regard  to  seven  specific  matters,  the  transaction  must
...
“Transaction”  is  defined  to  include  a  transaction,  operation  or
34.
...
situations involving single, multiple or composite transactions.
In Yick Fung
...
to  be  involved.
In  other  words,  a  transaction  can  be  carried  out  by  a  sole
protagonist and includes a unilateral scheme, plan etc.

35.
For  section  61A  to  apply,  the  identified  transaction,  operation  or
...
“the  parties  to  the  scheme,  insofar  as  they  are  known,  must  be
...
identified.
It is not sufficient to identify a scheme by reference to a
hoped for fiscal outcome.”

36.
In FCT v. Peabody, 28 ATR 344, the Australian High Court ruled that
if  a  wider  scheme  has  been  identified,  the  Commissioner  may  also  rely  on  a
narrow scheme (sub-scheme) as meeting Part IVA.
In other words, if part of a
...
“Tax benefit” is defined in section 61A(3) to mean “the avoidance or
37.
...
38.
In  Cheung  Wah  Keung  v.  CIR,  Woo  JA  rejected  the  argument  that
...
Section 61A provides that in deciding the sole or dominant purpose
39.
...
The  manner  in  which  the  tran
carried out

saction  was  entered  into  or
...
the  way  in  which  the  particular  transaction  was
structured;

(ii)

the  background  of  the  transaction,  the  time  at  which
...
the  way  in  which  the  taxpayer  operated  before  and
after  the  transaction  and  the  relevant  commercial
practices.

(b)

The form and substanc
...
In considering this matter it is necessary to compare
effect.
...
Any change in the financial position of the relevant person
...
Any change in the financial position of any person who has,
...
This  test  looks  at  the  rights  or  obligations  created  by  the
...
(g)    The  participation  in  the  tran

saction  of  a  corporation
...
40.
It  is  necessary  for  the  Assistant  Commissioner  to  consider  each  of
...
not  mean  that  a  14  per  cent  mark  can  be  attached  to  each  of  them.
In  this
...
otherwise  in  or  out  of  pocket,  and  the  same  for  connected  persons.
In  other
...
Section 61A requires that having regard to the seven listed matters a
41.
...
question.
In arriving at the decision, the strength or otherwise of the various
...
42.
The  presence  of  a  commercial  objective  in  a  particular  transaction
does  not  mean  that  section  61A  will  necessarily  have  no  application  to  that
In FCT v. Spotless Services Limited, 34 ATR 183, the Australian
transaction.
...
43.
Although the conclusion under section 61A(1) is an objective one, it
does  not  mean  that  the  intention  of  the  person  or  their  advisers  can  never  be
In  FCT  v.  Consolidated  Press  Holdings  Ltd,  47  ATR  229,  the
relevant.
...
It is clear that subjective purpose is not one of
...
44.
Obviously no problems will arise in cases where the sole purpose of
...
few problems.
In FCT v. Spotless Services Limited, the Australian High Court
...
Where the three prerequisites mentioned in paragraph 33 are satisfied,
45.
...
“in  such  manner  as  the  assistant  commissioner  considers
...
Section  61A  has  an  overriding  effect  and
...
The ultimate assessment to be made must be within the scope
...
(b)  	 Where  a  taxpayer  could  have  achieved  a  particular  financial
...
tax.
In other words, the Department accepts that a taxpayer
...
47.
Where the situation demands, the Assistant Commissioner will seek
...
48.
Sections 61 and 61A give similar powers to disregard the transaction
...
not mutually exclusive.  The decision of the Court of Appeal in the Yick Fung
...
49.
Where  a  tax  avoidance  arrangement  has  been  made  to  exploit  a
...
The  Ordinance  has  always  contained  provisions  which  enable
50.
...
to refuse to set off losses brought forward where he is satisfied that the sole or
...
51.
For  the  purpose  of  section  61B  the  Department  would  consider  a
change of shareholding as having been effected whenever shares are transferred
In other words, a change of shareholding
...
The  second  element  to  the  application  of  section  61B  is  the
52.
...
In order to decide whether profits have been
...
53.
It  should  also  be  noted  that  section  61B  refers  to  profits  received
...
54.
The  final  matter  which  must  be  considered  is  whether  the  sole  or
...
the  case  of  genuine  commercial  company
unnecessary
...
explained  in  paragraph  44  in  relation  to  section  61A.
In  other  words  the
...
The  Ramsay  principle  was  developed  by  the  courts  in  the  United
55.
...
56.
This principle is regarded as an approach in statutory interpretation, a
...
57.
In  applying  the  provisions  laid  down  in  the  Ordinance,  the
...
anti-avoidance  provisions.    As  was  stated  by  Lord  Cooke  (at  page  920)  in
...
constituent  steps  separately.
If  the  purpose  of  intermediate  steps  in  the
...
Penalties  are  provided  in  the  Ordinance  to  ensure  compliance  by
58.
...
Penalty  action  is  therefore  not  confined  to  evasion  cases,  but  may
59.
...
60.
Generally  speaking,  tax  evasion  attracts  heavier  penalty  than  tax
...
facts (i.e. facts have not been disclosed in the return, accounts or any statement
submitted to the Department), it is likely to be a scheme of tax evasion rather
than tax avoidance.

On the penalty aspect of tax avoidance cases, the Department takes
...
62.
In  considering  whether  any  penalty  action  should  be  invoked,  the
...
Following  the  enactment  of  section  39E  with  its  application  to  sale
63.
and leaseback and certain leveraged lease situations it is considered appropriate

25

to lay down what the Department considers are basic requirements for all leases.
...
In the latter case, of course, the
the sale of the goods purported to be leased.
...
In line with tax administrations in other parts of the world, factors to
...
the  existence  of  any  agreement,  express  or  implied,  and
...
the  degree  of  relativity  between  the  “residual  value”,  by
...
65.
So  far  as  factor  (a)  is  concerned,  an  agreement  will  generally  be
regarded as a purchase agreement if the lessee has a right or option to purchase
If in the opinion of the Commissioner, such right or option would
the goods.
...
It will correspondingly be unacceptable if the lessor has a
purchase the goods.
...
options  to  lease  the  goods  for  extended  further  periods,  and  the  terms  of  any
such  extension  will  also  be  examined  to  determine  whether  the  entire
arrangement really amounts to a purchase.

66.
As  to  residual  values,  it  is  the  usual  commercial  practice  for  the
...
In  situations  where  the  tax  deferral  benefits  to  a  leveraged  lessor
67.
...
had attaching to it a sole or dominant purpose of obtaining a tax benefit.
It is
...
they  are  to  be  acceptable  under  the  Ordinance.
the  following
that  future
requirements.

transactions  should  observe
...
Generally,  the  lease  period  should  not  exceed  10  years.
...
Lease transactions which provide for a rental rebate to be paid to the

27

Number of partners

Transactions involving more than 3 partners or where any partner’s
70.
...
Where  partners  in  a  leveraged  lease  partnership  have  common
71.
...
72.
The transaction should result in assessable profits to the partnership,
...
73.
The  total  rental  payable  under  the  lease  should  be  payable  in  equal
...
The  lessee/ultimate  end  user  must  be  a  Hong  Kong  operator  (see
74.
...
The lease should not involve any arrangement for the lodging by the
75.
lessee with the lessor of security deposits or for the lessee to make any kind of
advance  to  the  lessor.
In  relation  to  partners’  capital  contributions,  this
...
If  the  lessee  has  a  right  to  terminate  the  lease  on  payment  of  an
76.
...
Interest  on  moneys  borrowed  to  produce  assessable  profits  is
77.
...
Financing on a recourse basis should be for at least 51% of the cost
...
In cases which do not involve a limited partnership it is expected that
79.
lessors  themselves  contribute  capital  for  at  least  35%  of  the  cost  of  the
machinery  or  plant.
Interest  free  and  interest  bearing  loans,  even  with
...
80.
The  lessors  (which  generally  should  be  financial  institutions)  must
...
Leveraged  lease  transactions  that  do  not  comply  with  these
81.
...
Finally, the requirements set out above will be reviewed from time to
...
83.
The  Department  requires  maximum  disclosure  in  connection  with
...
Full name and Profits Tax file number.
...
(ii) 	   A schedule of the equipment showing for each item,
...
(vii)  	  A  statement  setting  out  details  of  all  cash  flows,
...
(ix)  A
  ...
  statement  showing  the  return  on  investment  in  the
...
its proposed date of execution; and,
...
(ii)  Any  prior  connections  between  vendor  and

purchaser.

(iii)    The reasons for the sale and acquisition.

In  relation  to  advance  rulings  on  leveraged  lease  transactions,  the
84.
...
86.
The  Department  will  not  entertain  applications  for  holdover  of
