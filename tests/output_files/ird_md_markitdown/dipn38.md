...
assessing  practice  followed  by
...
The  Inland  Revenue  Ordinance  (the  Ordinance)  has  since  1971
2.
...
3.
In  1961  the  House  of  Lords  handed  down  a  decision  in  Abbott  v.
...
The  taxpayer  concerned  in  Abbott  v.  Philbin  was  the  secretary  of  a
4.
...
5.
In  accordance  with  what  was  then  the  normal  practice  of  the
...
6.
The  law  relating  to  share  options  was  subsequently  amended  in  the
...
The  UK  amendments  were  considered  locally  in  the  course  of  the
7.
...
time the option is exercised.  The income to be charged should be the
difference between -
...
the  open  market  value  of  the  shares  at  the  date  of
...
The  Ordinance  was  subsequently  amended  by  Inland  Revenue
8.
...
....
6.
Clause  6  (which  follows  section  25  of  the  U.K.  Finance  Act
...
11.
Section  9(1)(d)  only  has  application  where  an  employee  (or  office
...
12.
The taxpayer in that case was the managing director of a company.
...
The taxpayer accordingly applied for shares and they were issued to him.  He
...
The respective meanings of the terms “exercise”, “assignment” and
13.
...
14.
The words in section 9(1)(d) quoted above dictate that the following
...
For  the  provisions  to  apply,  the  shares  (or  stock)  to  which  the
...
As  has  been  indicated  above,  section  9(4)  must  be  applied  to
15.
...
The Ordinance does not define what is meant by the word “exercise”
16.
...
It  is  important  to  ascertain  the  point  in  time  at  which  an  option  is
17.
...
18.
The gain that has to be calculated is a notional one; the question of
...
19.
Section 9(4)(a) provides, broadly put, that for the purposes of section
...
option, of the shares acquired and (b) the amount or value of the consideration
given for the shares and the grant of the option.

20.
Section  9(4)  also  provides  that  the  entire  consideration  shall  be
...
22.
Where  the  shares  are  listed  on  a  stock  exchange,  the  open  market
...
the  shares  are  listed  on  two  non-Hong  Kong  exchanges,  the  taxpayer  may
select the more favourable price.

Once the open market value of the shares is ascertained, the gain for
23.
...
24.
Where  the  option  exercised  is  in  respect  of  shares  in  a  private
...
25.
Nevertheless,  it  is  considered  that  guidance  as  to  the  correct
...
the  hypothetical  purchaser  would not  rely  only  on  information
...
26.
Where  an  option  has  been  exercised  over  shares  in  a  private
...
request for a meeting should be sent to the Commissioner.  The request should
...
27.
Section 9(4)(b) provides for cases where a right to acquire shares is
...
In  the  context  of  section  9(4)(b),  it  is  considered  that  the  term
28.
...
the  nature  of  the  relationship,  if  any,  of  the  assignor  to  the
assignee;
...
Within the context of section 9(4)(b), the term “release” refers to the
29.
...
It  should  be  noted,  however,  that  if  an  employee  were  to  receive
31.
...
32.
Cases sometimes arise where a right to acquire shares of a particular
...
the  employee  also  receiving  monetary
exchange
...
consideration), the Department will generally accept that the exchange does not
...
33.
As has been indicated in paragraph 5 above, prior to the introduction
...
Section 9(5) would not prevent the receipt of a right being charged to
34.
...
35.
Apart from valuation issues, questions concerning the application of
...
Section  9(1)(d)  provides  that  any  gain  realized  by  the
...
bearing  on  the  question  of  when  the  benefit  is  actually
...
36.
Although section 9(1)(d) provides that any gain realized (calculated
...
37.
The  source  of  the  income  mentioned  in    paragraph  36  above  is  the
...
on an unconditional basis during a year of assessment in which the person
...
Cessation  of  employment  does  not  prevent  the  application  of  the
38.
...
As  the  taxpayer  had  a  Hong  Kong  employment,  the  gain  would  be
39.
treated  as  having  been  derived  from  Hong  Kong.    The  gain  would  only  be

16

excluded  from  the  charge  to  Salaries  Tax  by  virtue  of  section  8(1A)(b)(ii),
...
As the taxpayer rendered all services outside Hong Kong during the
40.
...
The chargeability of any gain on exercise would not hinge on where
41.
...
42.
Accordingly,  having  regard  to  the  latter  point  in  the  previous
...
Where  a  person  has  a  non-Hong  Kong  employment  at  the  time  of
43.
...
44.
The  more  complex  situation  is  the  one  where  a  person  with  a  non-
...
In considering the  appropriate  proportion, if any, of the gain to be
45.
...
46.
For example, if the vesting period was two years (i.e. 730 days) and
...
The  provisions  of  section  8(1A)(b)(ii),  as  read  with  section  8(1B),
47.
...
48.
It  should  be  noted  that  for  the  purpose  of  determining  whether
...
49.
The  chargeable  portion  of  a  gain  of  the  kind  referred  to  under  the
...
The Ordinance does not require that the person be currently employed at
50.
...
As  the  taxpayer  rendered  all  services  in  connection  with  the
52.
...
53.
If  the  right  was  unconditionally  granted  to  the  taxpayer  before  he
...
54.
If,  however,  the  right  was  unconditionally  granted  to  the  taxpayer
...
In  a  case  involving  a  non-Hong  Kong  employment,  because  of  the
55.
...
above.  The assessable portion, if any, would be chargeable to Salaries Tax in
...
56.
The  option  may  be  granted  at  the  time  when  the  taxpayer  holds  a
...
As the option was derived by the taxpayer from both the non-Hong
57.
...
58.
For purposes of this part of the Practice Note, the terms “stock” and
...
59.
For salaries tax purposes, the time at which the shares accrue to the
...
employee, consideration will be given to whether the employee is entitled to
the full economic benefit of the shares.

60.
Experience  shows  that  the  terms  of  award  plans  in  most  cases  are
...
not have rights of a shareholder, he is not registered as a shareholder,
...
61.
For  the  present  purpose,  “vesting”  refers  to  the  time  when  the
...
Vesting period
applies?
Time of assessment  Upfront, i.e. at the time of  Back
the grant.
Market  value  at  time  of  Market  value  at  time  of
grant.
Yes.  The discount is to be  No.
...
the
restriction  period:  Not  vesting  period:  Taxable,
as  since  employee  is  entitled
taxable;
investment  income  since
to  the  shares  only  at  the
...
62.
The value of shares accruing in a year of assessment will be added to
...
If shares are subject to a vesting period, they are perquisite accruing
63.
...
The factual situation between share award and share option is not the
64.
...
In  section  11B,  the  assessable  income  of  a  person  in  any  year  of  assessment
...
65.
In  a  continuous  employment  situation,  it  is  generally  true  that  the
...
while  the  remaining  5,000  vested  shares  is  to  be  included  in  2008/09  and
255/365 of their value is subject to tax.

Inbound employee cases

An employee holding a non-Hong Kong employment may have been
66.
...
67.
Similarly, shares may have been granted to the employee holding a
...
On  1  October  2007,  the  5,000  shares  vested  in  him.    The  vesting  period  for
...
68.
Some employers may set up incentive schemes involving “phantom
...
The Department assesses the shares according to their market value
69.
...
70.
It will be appreciated from what is said in Part I that a gain realized
...
71.
If  a  person  wishes  to  make  such  an  election,  an  election  form  cum
...
As  a  further  concession,  the  Department  is  prepared  to  accept  an
72.
...
An  election  once  made  cannot  be  withdrawn  before  the  actual
73.
...
With  regard  to  share  awards  granted  but  not  yet  vested  in  the
74.
...
Where,  by  virtue  of  section  9(1)(d)  and  the  related  provisions
75.
...
The requirement to inform the Department can generally be satisfied
76.
...
77.
The obligation to inform the Department does not, however, depend
...
As  with  any  other  income  that  is  chargeable  to  tax,  serious
78.
...
79.
Employers  are  required  to  provide  information  in  respect  of  share
...
option  scheme,  full  details  of  how  the  scheme  operates  should  be  supplied  to
...
80.
It is also relevant that employers are generally issued with a notice each
...
Particulars  of  gains  realized  under  share  option  schemes  are  also
81.
...
82.
Where an employer is required to report details in respect of a gain
...
84.
The  Department  does  not  consider  that  there  is  unfairness  in
...
The  Department  will  generally  act  in  accordance  with  the  Practice
85.
