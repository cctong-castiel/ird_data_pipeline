...
These notes replace DIPN No. 11 (Revised) and DIPN No. 11A issued
...
Quantification of understatements in field audit
  and investigation
...
2.
The effective operation of Hong Kong’s simple tax system requires a
...
3.
Though the Ordinance does not contain a definition of “tax evasion”,
...
It  is  the  Department’s  view  that  the  term  “evasion”  includes  the
...
deliberate understatement of income or over-claiming of
deductions;

understatement of income or over-claiming of deductions
...
The  Field  Audit  and  Investigation  Unit  within  the  Department  is
5.
...
to provide a deterrent to tax evasion by the imposition of
penalties, either administratively or through the institution of
prosecution action; and

(c)

to educate taxpayers on the need to file proper and correct
returns.

6.
This  practice  note  is  to  provide  general  guidance  for  taxpayers  and
...
7.
Under section 51(1) of the Ordinance, a written notice may be given
...
In early April, the profits tax returns are issued to corporations
...
In early May, Individual Tax returns are issued to individuals
who  are  required  to  report  in  their  returns  the  assessable
profits derived from their sole proprietorship businesses.

For  all  taxpayers,  if  their  businesses  generate  gross  income
8.
...
Since April 2001, in order to streamline the assessing procedures, the
9.
...
assessments  are  then  selected  based  on  additional  criteria  for  audit  and
investigation by assessing officers.

10.
Returns not meeting the pre-set criteria for automated assessment are
...
11.
The implementation of the AFAL system enables the Department to
focus on assessing complex cases and conducting post assessment desk audits,
field audits and investigations.

12.
Under  the  AFAL  system,  a  customised  computer-assisted  case
...
13.
The  AFAL  system  has  been  built  on  an  analytical  solution  adopted
...
By  automating  the  screening  of  tax  returns,  the  AFAL  system
14.
...
brings  about
tax  compliance  and  more  effective
enforcement.
...
15.
Section 59(2)(a) of the Ordinance provides that where a person has
...
16.
In  field  audits  and  investigations,  it  is  necessary  that  additional
...
17.
The Commissioner’s power to review assessments previously raised
...
In  Nam  Tai  Trading  Co  Ltd  v.  Commissioner  of  Inland  Revenue,
18.
...
In  field  audits  and  investigations,  assessments  are  often  re-
another  year.
...
A field audit or investigation can be a time consuming exercise and
19.
...
to meet the 6 year time limit for raising back year assessments
under section 60 of the Ordinance;

in  deceased  cases  (under  section  54  of  the  Ordinance,  where
...
20.
Estimated  assessments  may  be  raised  on  a  person  under  alternative
...
21.
As  was  indicated  earlier,  it  is  in  the  taxpayer’s  interests  to  take  the
...
A  desk  audit  is  the  examination  of  an  automated  assessment  case.
22.
...
23.
The  Department  commenced  to  conduct  field  audits  of  taxpayers’
...
Field  auditors  ascertain  the  correctness  of  returns  not  only  by
24.
...
Field  audit  work  is  normally  focused  on  the  most  recent  year  of
25.
...
also be employed for ascertaining the amount of understatements of profits for
the years involved.

Investigation

Tax  investigation  is  an  in-depth  examination  where  tax  evasion  is
26.
...
A  taxpayer  should  make  a  full  voluntary  disclosure  as  soon  as  he
27.
...
investigation  and  has  provided  correct  returns
party,  has  facilitated
...
28.
It  is  assumed  in  this  practice  note  that  the  taxpayer  has  made  an
...
the value of stock in trade). In such a case, a simple statement showing the rate
and extent of the omissions will suffice.

29.
Paragraphs 56 to 80 below discuss ways in which the representative
...
The  activities  of  the  Field  Audit  and  Investigation  Unit  are  largely
30.
...
the  auditors’  report  in  respect  of  the  accounts  of  an
incorporated business is heavily qualified;

(b)

a  business  has  an  unreasonably  low  turnover  or  profit
...
failure  to  provide  material  information  requested  by  an
Assessor.

31.
Furthermore,  where  results  of  audits  or  investigations  indicate  that
compliance problems are prevalent in a particular trade or industry, field audits

9

or  investigations  on  a  project  basis  are  generally  undertaken  in  respect  of  the
trade or industry concerned.

Notification

A taxpayer selected for field audit or investigation will normally be
32.
...
33.
When the taxpayer responds to arrange the initial interview, the field
...
34.
At the outset, the taxpayer should give unambiguous instructions to
...
he  will  require  explanations  from  the  taxpayer  and  must
...
the  taxpayer  must  disclose  in  what  direction  his  tax  returns
have  been  incorrect  and  what  methods  of  concealment  or
omission have been adopted; and

the  field  audit  and  investigation  cannot  be  limited  to  the
...
The representative should at an early stage compile:

(a)

a list of the business books of the taxpayer;
...
a list of bank accounts which have been closed and particulars
of  properties  etc.  which  have  been  sold  in  Hong  Kong  or
overseas during the period covered by the investigation;

a summary of all tax returns submitted to the Department and
of  the assessments made, together with copies of the relevant
returns and notices; and

(f)

a list of the names of all members of the taxpayer’s family.

Initial interview

36.
At  this  stage,  the  field  auditor  or  investigator  seeks  to  gain  a
...
37.
The interview is a fact finding process.  At least two officers of the
...
It  is  important  to  note  that  a  field  audit  or  investigation  would  not
38.
...
As a token of co-operation, the taxpayer may at the initial interview
39.
...
The  Ordinance  contains  in  section  4  strict  secrecy  provisions  to
40.
...
After the interview, a record of the interview will be prepared by the
41.
...
Following the initial interview, the field auditor or investigator may,
42.
...
A  notice  may  also  be  issued  under  section  51(4)(a)  by  the  field
43.
auditor  or
investigator  requesting  further  particulars,  with  supporting
...
44.
A performance pledge in respect of the Department’s processing of
...
During  a  field  audit  or  investigation,  it  is  sometimes  necessary  to
45.
...
The initial interview in relation to a field audit case is attended by at
46.
...
the accounting and book-keeping procedures used within the
business;

the  personal  financial  affairs  of  the  taxpayer  and  associated
persons; and

(e)

the taxpayer’s personal and family living expenses.
...
Apart from seeking information relating to the above matters at the
47.
...
48.
One of the objectives of a field auditor’s initial field visit is to gain
...
49.
Field  auditors  are  aware  of  the  need  to  complete  any  audit  work
...
50.
The  field  auditor  aims  to  complete  small  simple  audit  cases  within
...
Section 51C of the Ordinance has set out in detail what are regarded
51.
...
52.
As was mentioned above, a taxpayer is usually asked to provide for
...
director’s or proprietor’s current account with the company;

(d)

any account with an abnormal balance;

(e)

any temporary account; and

(f)

any account with a long outstanding balance.

53.
In the course of checking movements in a director’s current account
...
Records and documents are examined to check whether they support
54.
...
55.
It  is  sometimes  claimed  that  an  absence  of  records  is  the  result  of
...
the  multiplicity  of  circumstances,  under  which
56.
...
Experience has shown that one of the common areas for irregularities
58.
...
59.
As  a  result  of  the  introduction  of  more  detailed  record  keeping
...
60.
In  such  circumstances,  the  representative  should  prepare  revised
...
auditor  or  investigator  for  verification.
...
member  of  the  taxpayer’s  family.  The  extent  of  scrutiny  undertaken  will
depend on the circumstances of the case.

Books and records incomplete or unreliable

The  Department’s  experience  has  been  that,  because  of  the
61.
...
62.
Preparation  of  an  Assets  Betterment  Statement  (ABS)  is  generally
...
63.
In essence, the function of an ABS is to disclose the correct taxable
...
Betterment Profits =  Increase in Net Assets + Disallowable Expenditure

- Non-taxable Receipts

The preparation of an ABS entails making a detailed analysis of the
64.
...
transfers with note of origin (e.g. from another bank account);

(b)

capital  receipts  with  brief  note  of  origin    (e.g.  sale  of
property);

(c)

income receipts with note of source;

(d)

other identified receipts with brief description;

(e)

unidentified receipts by specific cheques; and

(f)

unidentified receipts by cash.

Withdrawals -

(a)

transfers with note of destination;

(b)

capital  payments  with  brief  description  (e.g.  purchase  of
shares);

(c)

personal  payments  with  note  of  nature  (e.g.  school  fees,
household expenditure);

(d)

other identified payments with brief description;

(e)

	unidentified payments by specific cheques; and

(f)

unidentified payments by cash.

20

During the course of the initial analysis referred to above, it may not
65.
...
Concurrently  with  the  initial  analysis,  it  is  useful  to  prepare  three
...
an  annual  Assets  Statement  which  can  be  completed  as  the
assets emerge;

a  Statement  of  Personal  and  Living  Expenditure  on  which
identified items can be entered as they emerge; and

a  Statement  of  Income,  to  be  completed  as  each  item  is
identified.

The  Asset  Statement  of  an  individual  proprietor  should  include  all
67.
...
Once  the  initial  analysis  is  completed,  it  is  desirable  to  set  out  the
68.
...
(e) 	 Has the application of the disposal proceeds of each asset sold

been ascertained?

(f)

Has the application of all known income been ascertained?
...
69.
At this point the representative should consider whether the amounts
...
the  relevant  categories  of  domestic
...
70.
Finally,  it  is  necessary  to  consider  the  character  of  the  remaining
...
available  material.  However,  in  the  absence  of  evidence  to  the  contrary,  it
...
computing  the  Betterment  Profits  per  Appendix  A.
  For  unidentified
...
71.
When  the  matters  referred  to  in  paragraphs  69  and  70  have  been
...
72.
Although an analysis of the kind outlined above for an ABS should
...
The Bank Deposits Method is a means of ascertaining gross receipts,
73.
...
which business receipts have been deposited, including those held by nominees
of the taxpayer.

74.
For  wholly  or  partly  cash  trade  businesses,  it  is  worthwhile  to
...
In  G  Deacon  &  Sons  v.  CIR,  33  TC  66,  assessments  to  include
75.
taxable  profits  were  upheld  based  on
unexplained  bank  deposits  as
...
76.
This  method  involves  the  application  of  percentages  or  ratios
...
These  percentages  may  in  some  instances  be  determined  by
77.
...
78.
The  cases  of  Brittain  v.  Gibbs,  [1986]  STC  418  and  Coy  v.  Kime,
...
79.
In  Kudehinbu  v.  Cutts,  [1994]  STC  560,  the  estimated  assessments
...
Gross profit rate (as determined)

Gross profit as computed
Less: Gross profit per accounts

Additional profits (Discrepancy)
...
Where  the  representative  is  confident  that  the  taxpayer’s  assessable
80.
...
expenses  of
The  proportion  of  salaries  and
...
When a basis of settlement has been formulated by the field auditor
81.
...
Having  quantified  the  omitted  profits,  the  representative  or  the
82.
...
the materials the representative has taken into consideration;

(b)

(c)

the way he has done in regard to business books, and personal
finances;

the extent to which he has failed to obtain verification in any
direction; and

(d)

the  treatment  he  has  adopted  in  regard  to  unidentified  or
doubtful items.
...
A certificate signed by the taxpayer should accompany the proposal,
83.
...
During the course of the field audit or investigation, the field auditor
84.
...
Where agreement is reached on discrepancies, the taxpayer is asked
85.
...
The  settlement  form  only  covers  the  taxpayer’s  basic  tax  liabilities
86.
...
87.
Furthermore,  where  it  has  been  established  during  the  course  of  an
...
88.
Penalty  action  is  taken  in  respect  of  a  failure  to  comply  with  a
...
Since  1995,  field  auditors  have  been  deployed  to  specifically  work
89.
on  tax  avoidance  cases.  The  simple  objective  behind  the  initiative  was  to

29

enhance  the  Department’s  ability  to  counter  and  deter  the  use  of  blatant  and
...
90.
The  approach  adopted  in  tackling  avoidance  arrangements  places
...
As  with  normal  field  audit  cases,  field  visits  are  undertaken  in
91.
the  examination  of  possible  avoidance
to  cases
relation
...
Where transactions involve a related company incorporated overseas,
...
the  deductibility  of  expenses  or  payments  to  the  related
offshore company;

(b)

the extent to which the Hong Kong company’s expenses were
incurred  in  the  production  of  profits  of  the  related  offshore
company;

(c)

the chargeability to Hong Kong profits tax of the profits of the
related offshore company.

30

Pertinent  to  the  above  audit  issues  and  accordingly  to  the
93.
...
94.
Transactions  may,  of  course,  take  place  between  a  Hong  Kong
...
95.
From time to time, field auditors come across cases where offshore
...
the  working  papers  of  a

Situations  will  occasionally  arise  where  the  field  auditor  or
96.
investigator  requires  access
taxpayer’s
...
For  this  reason,  the  Department  has  developed  Access  Guidelines,
97.
which  have  been  formulated  having  regard
in  overseas
...
traditional accounting records, such as documents of original
...
the permanent audit file maintained by the taxpayer’s auditor
...
(a)
	 ...
	 papers  containing  advice  given  after  completion  of  a
...
papers  relating  solely  to  transactions  or  arrangements  that
have not been and are not intended to be implemented; and

(c)

tax  working  papers  which,
accountant’s opinion on matters contained in a tax return.

in  substance,  express  an

98.
The  distinguishing  feature  of  accounting  papers  is  that  they  detail
...
On  the  other  hand,  notwithstanding  the  broad  terms  of  the  powers
99.
...
100.
Under normal circumstances, a request for accounting papers would
...
101.
Field  auditors  have  encountered  instances  where  transactions
...
the taxpayer sells goods at a deflated price to the non-resident
person;
...
the taxpayer purchases goods at inflated prices from the non-
resident person;

(c)

the  non-resident  person  provides  various  services  to  the
taxpayer  for  substantial  fees,  which  are  not  commensurate
with the services; or

(d)

the  taxpayer  pays  substantial  royalties  to  the  non-resident
person.

102.
In  such  a  situation,  the  field  auditor  reviews  the  inter-company
...
103.
Where a taxpayer deals with a closely connected non-resident person
...
Sometimes  the  non-resident  person  dealing  with  the  taxpayer  is  a
104.
...
105.
The Department takes a serious view of any scheme which involves
...
the non-resident person does not carry out substantial activity
on its own in Hong Kong or elsewhere (e.g. it does not run an
office or employ staff);

the  taxpayer  performs  all  the  activities  in  Hong  Kong  which
in substance give rise to the profits;

there  is  no  commercial  justification  for  the  establishment  of
the non-resident person; and

(d)

the  profits  are  merely  “booked”  in  the  accounts  of  the  non-
resident person.
...
After  examining  relevant  documents  and  evaluating  evidence
106.
...
107.
If the taxpayer is unable to reach agreement with the field auditor, it
...
108.
One  of  the  main  purposes  underlying  the  Department’s  field  audit
...
“compound” the relevant offence (i.e. accept a monetary settlement instead of
sanctioning the institution of a prosecution).

Prosecution

Prosecution proceedings are considered to be an important means of
109.
...
110.
So far as is relevant, the maximum penalty under section 80 is a fine
...
The maximum penalty under section 82 is:
...
As  has  been  mentioned  above,  the  Ordinance  provides  that  as  an
112.
...
If  no  prosecution  has  been  instituted  under  section  80(2)  or  82(1)
113.
...
114.
Before making an assessment of additional tax, the Commissioner or
...
115.
It  should  be  noted  that  additional  tax  under  section  82A  of  the
...
In  assessing  penalties,  factors  taken  into  consideration  by  the
116.
...
117.
The  Department  makes  no  distinction  between  field  audit,
...
Finally,  the  Department’s  field  audit  and  investigation  operations
118.
...
Schedule
No. (Note 3)   Accounting Year End  (Note 2)
...
If the person carries on more than one business, the ABS should show the assets and
...
Summary of bank account analyses

ending on the accounting date (Note 2)

Total Deposits
Less :   Interbank Transfer or Deposits

Returned Cheques
Sales of Capital Assets
Rental Income
Other Non-business Deposits
...
______  ______  ______
 ...
 Add : Debtors’ Closing Balances

______  ______  ______

 Less : Debtors’ Opening Balances

______  ______  ______

 Less : Reported Turnover
