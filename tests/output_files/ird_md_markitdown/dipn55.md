...
-  Equal applicability in any branch or field of science or
...
Meaning of “qualifying expenditure related to trade, profession
...
Cost contribution arrangements/ subcontracting to other group
...
2. Application to software creation, FinTech and drug
...
2.
To encourage more enterprises to conduct R&D activities in Hong
...
The main provisions of the 2018 Amendment (No. 7) Ordinance are
...
Section  16B,  which  has  replaced  the  old  provisions,
generally provides for:

(i)

the deduction for expenditure on an R&D activity; and

(ii)

the  treatment  of  the  proceeds  of  sale  of  plant  or
machinery  for,  and  rights  generated  from,  an  R&D
activity as trading receipts.

(b)

Part 1 of Schedule 45 (which contains 12 sections) provides
...
designated local research institution;

(ii)

qualifying  expenditure  related  to  trade,  profession  or
business;
...
Part  2  of  Schedule  45  contains  3  sections  (sections  13,  14
and 15):

(i)

Section  13  provides  for  the  calculation  of  the  total
...
Section  14  provides  for  safeguards  to  prevent  the
...
Part 3 of Schedule 45 consists of 2 sections (sections 16 and 17):

(i)

(ii)

Section 16 provides for the treatment of the proceeds
of sale of plant or machinery as trading receipts.    It is
substantially the same as the provisions replaced.

Section 17 provides for the treatment of the proceeds
...
Part 4 of Schedule 45, which contains 2 sections (sections 18
and 19), deals with miscellaneous matters:

(i)

Section  18  empowers  the  Commissioner  of  Inland
...
(f)    Part  5  of  Schedule  45  provides  for  a  transitional  provision
...
Section 15(1)(bc) is added to make it clear that the following
sums are trading receipts chargeable to profits tax:

(i)

sums received by or accrued to a person for the use, or
...
sums received by or accrued to a person for imparting
...
Despite that an expenditure on an R&D activity is generally capital
4.
...
R&D  expenditures  eligible  for  deduction  under  section  16B  are
5.
...
amount.    The rates of enhanced tax deduction would apply uniformly across
...
The  term  “R&D  activity”  is  defined  in  section  2  of  Schedule  45.
...
an  activity  in  the  fields  of  natural  or  applied  science  to
extend knowledge;

a  systematic,  investigative  or  experimental  activity  carried
on for the purposes of any feasibility study or in relation to
any market, business or management research;

an  original  and  planned  investigation  carried  on  with  the
...
7.
The  above  definition  is  no  different  from  that  for  “research  and
...
application of any existing research findings or knowledge to a plan or design
...
to  any  market,  business  or  management

  Further,  a  systematic,

research,

“R&D  activity”  can  therefore  be  described  as  an  activity  working
8.
...
routine  testing  of  materials,  devices,  products,  processes,
systems or services;
...
routine,  cosmetic  or  stylistic  modifications  or  changes  to
...
The phrase “substantially improved” means to change or adapt the
9.
...
improvement should be more than a  minor or routine upgrading, and should
...
The  objectives  of  the  enhanced  tax  deduction  are  to  encourage
10.
...
falls within the description in section 2(a), (c) or (d) of this
Schedule; and
...
11.
The  definition  of  “qualifying  R&D  activity”  is  primarily  built  on
...
relation to any market, business or management research, which are generally
...
any  efficiency  survey,  feasibility  study,  management  study,
market research or sales promotion;

the application of any publicly available research findings or
other  knowledge  to  a  plan  or  design,  with  an  anticipated
outcome  and  without  any  scientific  or  technological
uncertainty;

an  activity  that  does  not  seek  to  directly  contribute  to
...
The exclusions are made with due regard to those adopted in other

13.
The scope of “qualifying R&D activity” indicates that a qualifying
...
14.
The requirement “wholly undertaken and carried on in Hong Kong”
in  section  4(1)(b)  of  Schedule  45  does  not  mean  that  the  whole  of  an  R&D

8

project must be carried on in Hong Kong.    An R&D project often consists of
...
15.
It is important to get the boundaries of an R&D project correct.    In
...
mathematical  advances  in  and  of  themselves  are  not  science  unless  they  are
...
18.
Overall knowledge or capability in a field of science or technology
...
Even if the advance in science or technology sought by a project is
...
Therefore,  a  project  which  seeks  to  achieve,  for  example,  the
...
create a material, device, product, process, system or service
...
to  develop  a  new  biometric
authentication  technology  unknown  in  the  market.    Their  projects
were  similar.  Enterprise  HK-1  succeeded
in  achieving  a
...
21.
Scientific  or  technological  uncertainty  exists  when  knowledge  of
...
22.
System  uncertainty  is  scientific  or  technological  uncertainty  that
...
Similarly,  work  on  combining  standard
technologies,  devices,  and/or
...
resolve  an  element  of  the  scientific  or  technological  uncertainty  associated
  Activities  which  directly  contribute  to
with  achieving  the  advance.
...
Activities  which  do  not  directly  contribute  to  the  resolution  of
...
marketing  of  a  new  or  substantially  improved  material,
...
administration and other supporting services; and
...
26.
In  relation  to  a  qualifying  R&D  activity,  the  R&D  project  begins
...
in  the  field,  or  when  a  prototype  or  pilot  plant  with  all  the  functional
...
27.
Although an R&D project for a material, device, product, process,
...
Scientific  or  technological  planning  activities  associated  with  a
28.
...
assessing  scientific  or
identifying  particular
technological  feasibility,
scientific  or
technological  uncertainties,  estimating  development  time,
...
29.
Elements of an enterprise’s planning activities relating to an R&D
...
Not  all  projects  succeed  in  their  aims.    Registration  of  patents  is
30.
...
technology,  not  whether  ultimately  the  associated  scientific  or  technological
...
33.
Information or other content which is delivered through a scientific
...
34.
The  enhanced  tax  deduction  can  benefit  all  sectors  including  the
...
There is guidance on the meaning of R&D for tax purposes in BE
35.
...
36.
On  the  subject  of  computer  games,  Mr.  Justice  Evans-Lombe
...
37.
Mr.  Justice  Evans-Lombe  was  presented  with  an  extensive
...
38.
Since  the  Department  may  not  have  sufficient  knowledge  in  the
...
39.
For the purpose of seeking advice from the Commissioner for I&T,
...
“R&D expenditure”  may  be either in the form of a payment to an
40.
...
a payment to an R&D institution for an R&D activity related
to the trade, profession or business;

a payment to an R&D institution which has, as an object, the
...
any  other  expenditure  on  an  R&D  activity  related  to  the
...
It is specifically provided in section 6(2) and (4)(b) of Schedule 45
41.
...
42.
For an in-house R&D activity, R&D expenditure would include any
...
43.
No  deduction  is  allowable  under  section  16B  in  respect  of  any
...
44.
The term “R&D institution” is defined in section 6(5) of Schedule
...
any  other  institute,  association,  organisation  or  corporation
located  in  Hong  Kong  that  undertakes  qualifying  R&D
activities in Hong Kong.

45.
R&D service providers which provide R&D services in Hong Kong
...
(www.itc.gov.hk/en/dlri/index.htm).
...
Section  7(1)  of  Schedule  45  provides  that  an  R&D  expenditure  is

(a)

(b)

for a payment made to an R&D institution – at the time the
payment is made by the person; or

for  an  in-house  R&D  expenditure  –  at  the  time  the
expenditure is incurred by the person.

47.
However, for a person who is about to carry on a trade, profession
...
“Type  A  expenditure”  is  defined  in  section  8  of  Schedule  45.    A
48.
...
for  a  payment  made,  or  other  expenditure  incurred,  on  or
after the Commencement Date – an R&D expenditure other
than a Type B expenditure; or

for  a  payment  made,  or  other  expenditure  incurred,  during
...
“Interim  Type  A  expenditure”  is  defined  in  section  9  of
...
a payment made during the specified period that:

(i)

would  have  been  deductible  under  section  16B(1)(a)
...
is  made  during  the  specified  period  to  a  university,
...
any  other  expenditure  (specified  expenditure)  incurred
during the specified period that:

(i)

would  have  been  deductible  under  section  16B(1)(b)
of the pre-amended Ordinance; and
...
50.
Thus,  payments  made  to  an  R&D  institution  and  in-house
...
section  16B  of  the  pre-amended  Ordinance,  continue  to  be  deductible  as  an
...
51.
“Type  B  expenditure”  is  defined  in  section  10(1)  of  Schedule  45.
...
a payment to a designated local research institution for
a  qualifying  R&D  activity  related  to  the  trade,
profession or business;

a  payment  to  a  designated  local  research  institution
...
Under section 11 of Schedule 45, an interim Type B expenditure is:
...
53.
The combined effect of sections 10 and 11 of Schedule 45 is that as
...
54.
In  order  to  allow  taxpayers  to  claim  back  100%  deduction  or
...
that  is  not,  and  never  has  been,  a  designated  local  research
institution,
...
55.
Sections 3 and 5 of Schedule 45 define what are meant by an R&D
...
an R&D activity  that  may lead to or facilitate an extension,
...
an  R&D  activity  of  a  medical  nature  that  is  of  particular
relevance to the welfare of employees employed in the trade,
profession  or  business;  or  the  class  of  trade,  profession  or
business.

A qualifying R&D activity related to a trade, profession or business;
...
a  qualifying  R&D  activity  that  may  lead  to  or  facilitate  an
...
a  qualifying  R&D  activity  of  a  medical  nature  that  is  of
particular relevance to the welfare of employees employed in
the  trade,  profession  or  business;  or  the  class  of  trade,
profession or business.

57.
To qualify for deduction under section 16B, the R&D activity or the
...
58.
In  Salt  v  Golding  [1996]  STC  (SCD)  269,  the  question  was  what
...
59.
Payments  to  R&D  institutions  including  designated  local  research
...
60.
The  deduction  is  allowed  irrespective  of  the  actual  usage  of  the
...
61.
Payments  made  to  R&D  institutions  under  section  16B  should  be
...
It should, however, be noted that any payment made to a designated
62.
...
63.
According  to  the  empirical  studies  of  European  Union  and  the
...
an  expenditure  in  relation  to  an  employee  who  is  engaged
directly and actively in a qualifying R&D activity related to
the trade, profession or business; or

an expenditure on a consumable item that is used directly in
...
Under section 12(5) of Schedule 45, “expenditure in relation to an
...
an  ordinary  annual  contribution  to  a  fund  duly
occupational
under
established
retirement scheme;
...
an ordinary annual premium in respect of a contract of
...
any contributions made to a mandatory provident fund
...
any other benefit that constitutes a cash outlay paid by
the employer; and

(b)

does not include any remuneration of a director, or any item
...
65.
Staffing  costs  on  employees  engaged  directly  and  actively  in  a
...
66.
If  staff  is  only  involved  in  a  qualifying  R&D  activity  for  part  of
...
Persons  not  themselves  directly  and  actively  engaged  in  a
67.
...
68.
Where  an  individual  has  a  contract  of  employment  with  an
...
69.
To  constitute  an  expenditure  in  relation  to  an  employee  (i.e.  a
...
70.
Apart from salaries, wages and retirement benefits set out in section
...
Remuneration paid to directors and shadow directors as defined in
...
72.
An  expenditure  incurred  on  consumable  items  used  directly  in  a
...
74.
Section 12(4)(b) of Schedule 45 specifies that a consumable item is
...
Where  consumable  items  are  partly  used  directly  in  a  qualifying
75.
...
the  qualifying  R&D  activity.
  If  the  enterprise  offers  a  reasonable
...
76.
R&D  expenditures  not  falling  within  the  definition  of  “qualifying
trade,  profession  or  business”  (e.g.  director’s
expenditure  related
...
for expert advice, licence fees paid for the use of intellectual property rights,
incidental testing fees paid to testing labs, etc.) may still be eligible for 100%
deduction as Type A expenditures.

No additional deduction would be given for an expenditure incurred
77.
...
78.
Section  13  of Schedule 45  sets  out  the formula for calculating  the
...
for  Type  A  expenditures  –  subject  to  section  13(3)  of
...
if  the  total  amount  of  the  expenditures  exceeds
...
if the total amount of the expenditures does not exceed
...
Staffing costs of the research team
Consumable items
Consultancy fee paid to an independent expert
Testing fee
Total
...
79.
Where any Type A expenditure, which qualifies for 100% deduction
...
80.
If the trade, profession or business is carried on partly in, and partly
...
81.
Section  14  of  Schedule  45  specifies  certain  circumstances  under
...
82.
Section 14(a)(i) of Schedule 45 provides that no deduction is to be
...
83.
Co-ownership  of  rights  is  covered  by  section  1(2)  of  Schedule  45
...
the  R&D  expenditure  incurred  by  each  of  the  enterprises  involved  can  be
...
84.
It  is  not  uncommon  to  use  special  purpose  vehicles  to  hold
...
Enterprise-HK
they  were  beneficially  owned  by
...
85.
Section 14(a)(ii) of Schedule 45 further specifies that no deduction
...
undertaken  for  another  enterprise.    The  reason  behind  this  is  that  the  R&D
...
engaged directly and actively in the qualifying R&D activity, under
section 16B provided that other conditions were also satisfied.

86.
Payments  made  to  “R&D  institution”  (including  “designated  local
...
87.
Associated  enterprises  in  a  multinational  group  may  enter  into  a
...
Two  types  of  CCAs  are  commonly  encountered:  those  established
88.
...
89.
Where  the  enterprise  has  undertaken  part  or  all  of  the  underlying
R&D  activity  under  a  development  CCA,  the  share  of  R&D  expenditure

38

borne by the enterprise under the CCA may be accepted by the Commissioner
...
the
balancing  payments  should  be  made
to  ensure
the
proportionate  shares  of  contributions  align  with
the
...
The  arrangement  may  specify  provision  for  balancing
...
material changes in proportionate shares of expected benefits
...
the  R&D  project  are  no  more

The enterprise  must  actively participate in the R&D project
...
possess  the  capacity,  knowledge  and  expertise  to
control performance of the DEMPE functions;

have  the  financial  capacity  and  capability  to  do  so;
and
...
The R&D activity under the CCA must be undertaken for all
...
It  should  be  noted  that  only  qualifying  R&D  activities  (i.e.
90.
...
91.
Sometimes, the enterprise may incur R&D expenditure in excess of
...
92.
Where  the  value  of  a  participant’s  share  of  overall  contributions
...
proportionate  expected  benefits.    Such  adjustments  may  be  anticipated  by
...
93.
Variations  between  a  participant’s  proportionate  share  of  the
...
94.
It is crucial that the value of the enterprise’s contributions under the
...
95.
Subsequent  transfer  pricing  adjustments  made  by  other  tax
jurisdictions  in  respect  of  the  income,  including  royalty  income,  allocated

42

between the associated enterprises under a CCA would also trigger the need to
...
under a CCA and the intellectual property generated from the R&D
...
RAB in Year 1 (Note 1)
RAB in Year 2 (Note 2)
...
For  the  purpose  of  determining  whether  a  CCA  satisfies  the  arm’s
...
the  participants  would  charge-out
the  whole  amount  of
...
Type  A  and  Type  B  expenditures  directly
incurred  by
  Therefore,  Enterprise-HK  could  only  claim
Enterprise-HK.
...
96.
An enterprise that becomes a participant in an already active CCA
...
participant leaves a CCA.    In particular, a participant that leaves a CCA may
...
Subcontracting  should  be  distinguished  from  a  CCA.    Under  a
97.
...
the  100%  deduction  under  section  16B.
...
Clearly,  the  above  mentioned  arrangement  would  not  be  regarded
  Since
as  a  CCA  but  a  pure  subcontracting  arrangement.
...
qualifying  R&D  activity.    Therefore,  Enterprise-HK  would  be
...
98.
Section  14(b)  of  Schedule  45  stipulates  that  no  deduction  can  be
...
99.
So where an enterprise incurs an R&D expenditure and part of such
...
Section 14(b) of Schedule 45 only covers those scenarios where the
100.
...
because  proceeds  from  sale  of  the  goods  or  contractual  payments  under  the
...
of  the  intellectual  property  should  be  eligible  for  enhanced
...
Section  14(c)  of  Schedule  45  introduces  a  main  purpose  test  for
101.
tackling
involving  deduction  of  R&D
tax  avoidance  arrangements
...
a  deduction  to  which  the  person  would  not  otherwise  be
entitled under section 16B; or

a  deduction  of  a  greater  amount  than  the  amount  to  which
the person would otherwise be entitled under section 16B.

102.
This  provision  only  targets  at  those  who  seek  to  exploit  the  R&D
...
further  subcontracted  the  R&D  project  to  another  institution  at  a
...
the
$100  million  qualifying  expenditure  was  booked
...
the R&D expenditure should be Enterprise-HK1.    The underlying
...
Enterprise-HK3 to obtain tax loss relief arising from the enhanced
  Since  Enterprise-HK1,
deduction  of  R&D  expenditure.
into  an
Enterprise-HK2  and  Enterprise-HK3  had  entered
...
Expenditures on consumable items
...
qualifying  R&D  activity.    Then  Enterprise-HK  could  only  claim
...
103.
Under section 15 of Schedule 45, an R&D expenditure may only be
...
Despite the exclusion relating to the sale of capital assets in section
104.
...
105.
Under  section  16  of  Schedule  45,  where  plant  or  machinery  in
...
106.
Where any such plant or machinery is destroyed, it is to be treated
...
107.
Under section 17 of Schedule 45, where any rights generated from
...
If the expenditures deducted for the R&D activity or activities that
108.
...
109.
On the other hand, if the expenditures deducted for the underlying
...
If any relevant Type A expenditure for the underlying activities was
110.
...
111.
Section 17 of Schedule 45 is also applicable in situations where the
...
enterprise.
  This  follows  transfer  pricing  principles  under  which  an
...
112.
Sections 16 and 17 of Schedule 45 would apply to a sale of plant or
...
113.
Section  15(1)(bc)  of  the  Ordinance  stipulates  that  the  following
...
sums for the use, or the right to the use, outside Hong Kong
...
sums  for  imparting  or  undertaking  to  impart  knowledge

60

directly  or  indirectly  connected  with  the  use  outside  Hong
...
114.
Under  section  15(8),  the  term  “intellectual  property”  includes
...
115.
According to the international tax rules, income should be taxed at
...
Ordinance as appropriate to counteract the tax benefit which would otherwise
be obtained.

117.
In Vaccine Research Ltd Partnership v HMRC (and related appeals)
...
Similarly,  in  Brain  Disorders  Research  Ltd  Partnership  and
118.
...
incurred on any scientific research in any amount in excess of 6.    The Upper
Tribunal and the Court of Appeal upheld this decision.

119.
The  above  two  cases  are  examples  of  blatant  tax  avoidance
...
120.
Since  R&D  always  involves  a  significant  amount  of  investment,
...
Examples  illustrating  the  principles  on  “qualifying  R&D  activity”
121.
...
An  enterprise  conducted  extensive  market  research  to
...
qualifying  R&D  activity,  as  were
the  activities
...
the  project’s  scientific  or
contribute
resolving
therefore  not
technological  uncertainties  and  were
...
Searching  for  the  molecular  structures  of  possible  new
...
a  particular  set  of  data)  is  itself  entirely  routine.    The
...
An  advance  in  science  or  technology  need  not  imply  an
...
equipment  from  being  an  advance
in  science  or
...
An  enterprise’s  project  involved  finding  a  new  active
ingredient
in  overall
...
the new active ingredient for use in a commercial product.
Both  of  these  would  constitute  an  advance  in  science  or
technology.

In  order  to  achieve  this  advance,  a  programme  of
...
An  enterprise  was  in  the  electronics  business.    While  it
...
to identify the requirement, characterise the wire, test and
...
A food manufacturing start-up wished to develop a lower
...
activity since it sought to achieve an advance in science or
technology which was not known at the beginning.

3.4

A  flour  manufacturer  aimed  at  developing  an  authentic
...
spiky surface pattern; and

(d)

thin and good adhesive coating.
...
commercially  available  premixes.
  The  enterprise
...
to  produce
A  construction  material  maker  wished
translucent concrete using plastic optical fibres.    Existing

vi

products  available  in  the  market  only  used  glass  optical
...
investigate
the  effects  of  optical  fibre  ratios  and
...
Work  to  compare  the  effectiveness  of  two  possible
designs  for  controlling  part  of  a  new  manufacturing
process  would  directly  contribute
the
...
technological uncertainty  (e.g. by  paying for work), does
...
Innovation  is  important  in  establishing  whether  a  project
...
results  written  up  as  part  of  a  knowledge  capture
...
An  enterprise  was  seeking  to  make  a  water-breathable
...
technological  uncertainty  around
was  scientific  and
whether
...
whether  competent  professionals  working  in  the  field
would accept that such change would involve scientific or
technological uncertainty.

An  enterprise  developed  new  spark  plugs  for  use  in  an
...
resolved,  and
the  qualifying  R&D  activities  were
...
Where software is developed as a tool for direct use in a larger R&D
1.
...
2.
Software  applications  or  components  of  applications  will  normally
...
supporting,  de-bugging  or  making  minor  improvements  to
existing computer software;

adaption of functions of commercially available software into
a customised business application;

handling  interactions  with  users  (e.g.  development  of  data
entry procedures and user interface design);

arranging  visual  presentation  of  information  to  users  such  as
dashboard creation;
...
creating  a  software  application  that  replicates  an  established
paper  procedure,  possibly  building  in  best  practices  (i.e.  a
previously manual task has been automated);

assembling  data,  carrying  out  routine  operations  on  data  and
presenting data;

using  standard  methods  of  encryption,  security  verification
and data integrity testing; and

creating  websites  or  software  using  tools  designed  for  that
purpose.
...
The following software projects are likely qualifying R&D activities:
...
handling  application  program  interfacing  where  unknown
program interactions require new technical solutions;

creating  new  search  engines  using  materially  new  search
methods;

designing complex data capture and analysis tools that require
new technical solutions;

resolving  conflicts  within  hardware  or  software,  where  the
existence  of  a  problem  area  and  the  absence  of  a  known
solution have been documented;

creating  new  or  more
...
creating  new  encryption  or  security  techniques  that  do  not
follow established methodologies; and

developing  an  artificial  intelligence  system  with  human-level
reasoning capability.

4.
Assembling  components  of  a  program  to  an  established  pattern  or
...
There  are  always  uncertainties  involved  with  software  development
5.
...
design  uncertainties  rather  than  technological  uncertainties.
  Technical
...
Routine testing steps in software development projects are not for the
6.
...
testing  the  efficiency  of  different  algorithms  that  are  already
known to work; and
...
A  large  scale  application  software  project  typically  entails  the
7.
...
In  practice,  the  Assessor  will  likely  request  for  further  information

(a)

(i.e.

Substantive  information  is  provided  on  the  commercial
...
Sufficient  information  is  not  provided  on  the  studies  in  the
field  of  science  or  technology  conducted  for  the  application
software project.

iv

(c)      The entire application software development project is wrongly
...
It  is  wrongly  assumed  that  the  complexity  of  the  integration
...
It  is  wrongly  assumed  that  engaging  a  software  firm  to
...
such  software  to  analyse,  for  example,  customer  spending  patterns,
...
lightweight  architecture  supporting  the  execution  of  the
high-speed data;

identification  of  the  various  parameters  and  patterns  for  the
...
smart ways to filter input data;

(f)

speed and reliability of the execution;
...
Since  the  above  R&D  project  sought  to  directly  contribute  to
...
the  finance,  treasury  and  human  resources
processes  across
...
9.
FinTech,  the  application  of  information  technology  to  the  provision
...
“FinTech” is a loose term embracing a wide range of applications of
10.
...
11.
Many  financial  institutions  and  FinTech  start-ups  are  undertaking
...
“robo  investment  advisor”  would  be  able  to  perform  the  following
...
capturing data from various sources and analysing more than
ten thousands of variables simultaneously;

individual  securities  (including  stocks,  bonds,
selecting
debentures,  derivatives,  etc.)
for  building  diversified
investment portfolios for clients with different risk profiles and
investment preferences;

(c)

executing  clients’  instructions  and  carrying  out  financial
...
interacting with clients and answering their enquiries.
...
12.
Enterprises in the pharmaceutical industry  that undertake R&D into
...
Preclinical  development  –  This  stage  involves  the  initial
...
Clinical  development  –  Clinical  trials  are  initiated  when  an
...
Phase I strategic work is often referred to as “situation
...
to  small  numbers  of  healthy
by  administration
the  maximum
volunteers.  This  stage  establishes
...
documentation,  results  from  Phase  I  to  III  trials  and
...
trials  are  sometimes  described  as  “Phase
IIIb”
(post-submission  but  pre-registration).
  When  the
...
Post launch – Phase IV clinical trials occur once a product has
...
It  seems  to  be  the  case  that  the  research  activities  of  discovery,
13.
...
For some drug development cases, Phase III clinical trials may also
14.
involve resolution of scientific or technological uncertainty.    If this is the case,

xii

Phase  III  clinical  trials  can  also  be  regarded  as  a  qualifying  R&D  activity.
...
Some  of  the  work  within  the  phases  will  not  qualify  for  enhanced
15.
...
16.
Enterprises  can  produce  generic  versions  of  existing  drugs  that  are
...
Clinical trials involve the testing of the drug in both healthy patients
17.
...
The  Assessor  would  be  sympathetic  and  supportive  when  dealing
1.
...
2.
The  enhanced  deduction  for  R&D  expenditure  is  intended  to
...
Some of the risk factors the Assessor may consider when examining
3.
...
When asking questions about a claim, the size of the enterprise and
4.
...
the  particular  scientific  or  technological  uncertainties  that
needed to be resolved to seek the advance;

in what way does the project go beyond what was the current
state of knowledge;
...
6.
Mr.  Justice  Evans-Lombe  said  that  the  provisions  of  the  relevant
...
7.
Mr. Justice Evans-Lombe stressed the need to identify any scientific
...
8.
All  claims  for  deduction  of  R&D  expenditure  are  subject  to  a  risk
...
During the course of an enquiry into a claim for deduction of R&D
9.
...
The  requirements  for  the  production  of  records  will  be  kept  to  the
10.
...
11.
The  Assessor  handling  the  enterprise’s  profits  tax  matters  will  not
...
12.
Every  officer  appointed  under,  or  employed  to  carry  out  the
...
13.
The  Assessor  will  keep  enterprises  informed  of  the  progress  of  the
...
There  are  some  risk  factors  that  are  of  particular  relevance  when

(a)

(b)

If there is no analysis of how the amount of deduction claimed
...
The nature of the trade may mean that it is more important to
...
The activity may not be a qualifying R&D activity even if it is
...
the  case  for  the  purposes  of  the  enhanced  deduction  claim,
though  the  expenditure  relating  to  an  R&D  activity  may  be
eligible for 100% deduction.

(d)

The absence of an R&D disclosure in the accounts should not
...
15.
Enterprises  are  required  to  keep  sufficient  records  to  substantiate
...
For  a  qualifying  R&D  activity,  enterprises  would  commonly  be
...
the R&D project (or the larger commercial project in which it
...
the  specific  areas  of  scientific  or
an
...
the  particular  expertise  specific  employees,
Notes  on
...
Information about any major changes to the objectives, or new
...
Internal progress reports and minutes of project meetings.

However, particularly for small enterprises, not all of the above may
18.
...
Besides,  enterprises  are  required  to  keep  the  following  R&D
...
evidence of the payments made to the R&D institutions, such
...
list  of  R&D  staff  with  details  on  their  qualifications  and
professional competence;

(d)

employment contracts for R&D staff;

(e)

(f)

payroll records like payroll slips, retirement fund contribution
statements;

timesheets  for  R&D  staff  who  do  not  work  full  time  on  the
R&D project;

(g)

invoices or receipts for consumable items purchased;
...
evidence, such as internal cost accounting codes, showing that
the  staffing  costs  and  consumable  items  were  properly
charged to the R&D project;

In  case  freelanced  R&D  workers  or  R&D  staff  provider  was
...
20.
Where the enterprise has obtained funding to undertake the project, it
...
commercially  unique  without  constituting  or
...
21.
In cases where the background material shows that a final product is
...
22.
A project funded under the Innovation  and  Technology  Fund (ITF),
...
In relation to a deduction claim for R&D expenditure incurred under
23.
...
a list of participating associated enterprises;

(b)

a list of any other associated enterprises that will be involved
...
the  scope  of  the  activity  and  specific  project  covered  by  the
...
the  manner  in which any future benefits, such as intangibles,
...
exploitation of intangibles or tangible assets used in the R&D
...
the procedures for and consequences of a participant entering
...
any  change  to  the  arrangement  (e.g.  in  terms,  participants,
subject activity), and the consequences of such change;

a comparison between projections used to determine the share
of  expected  benefits  from  the  R&D  activity  or  qualifying
R&D activity under the CCA with the actual share of benefits;
and

the  annual  expenditure  incurred  in  conducting  the  R&D
...
The  Assessor  is  expected  to  be  provided  with  a  copy  of  the  CCA
24.
